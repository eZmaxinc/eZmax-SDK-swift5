...
```swift
    open class func inscriptionchecklistGetAutocompleteV2(sSelector: SSelector_inscriptionchecklistGetAutocompleteV2, fkiID: String? = nil, eType: EType_inscriptionchecklistGetAutocompleteV2? = nil, eFilterActive: EFilterActive_inscriptionchecklistGetAutocompleteV2? = nil, sQuery: String? = nil, acceptLanguage: HeaderAcceptLanguage? = nil, completion: @escaping (_ data: InscriptionchecklistGetAutocompleteV2Response?, _ error: Error?) -> Void)
```
...
let fkiID = "fkiID_example" // String | Specify which fkiID we want to display. (optional)
let eType = "eType_example" // String | The type of Inscriptionchecklist (optional)
let eFilterActive = "eFilterActive_example" // String | Specify which results we want to display. (optional) (default to .active)
let sQuery = "sQuery_example" // String | Allow to filter the returned results (optional)
let acceptLanguage = Header-Accept-Language() // HeaderAcceptLanguage |  (optional)

// Retrieve Inscriptionchecklists and IDs
ObjectInscriptionchecklistAPI.inscriptionchecklistGetAutocompleteV2(sSelector: sSelector, fkiID: fkiID, eType: eType, eFilterActive: eFilterActive, sQuery: sQuery, acceptLanguage: acceptLanguage) { (response, error) in
