...
let ezsignfoldertypeCreateObjectV3Request = ezsignfoldertype-createObject-v3-Request(aObjEzsignfoldertype: [ezsignfoldertype-RequestCompoundV3(aFkiUserIDSigned: [123], aFkiUserIDSummary: [123])]) // EzsignfoldertypeCreateObjectV3Request | 
...
let ezsignfoldertypeEditObjectV3Request = ezsignfoldertype-editObject-v3-Request(objEzsignfoldertype: ezsignfoldertype-RequestCompoundV3(aFkiUserIDSigned: [123], aFkiUserIDSummary: [123])) // EzsignfoldertypeEditObjectV3Request | 
