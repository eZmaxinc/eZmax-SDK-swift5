...
```swift
    open class func ezsignsignatureEditObjectV2(pkiEzsignsignatureID: Int, ezsignsignatureEditObjectV2Request: EzsignsignatureEditObjectV2Request, completion: @escaping (_ data: EzsignsignatureEditObjectV2Response?, _ error: Error?) -> Void)
```
