...
open class ObjectAttachmentAPI {
     ...
     */
    @discardableResult
    open class func attachmentDownloadV1(pkiAttachmentID: Int, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: AttachmentDownloadV1Response?, _ error: Error?) -> Void)) -> RequestTask {
    ...
    /**
     ...
     - API Key:
       ...
       - name: Authorization
     - parameter pkiAttachmentID: (path)  
     - returns: RequestBuilder<AttachmentDownloadV1Response> 
     */
    open class func attachmentDownloadV1WithRequestBuilder(pkiAttachmentID: Int) -> RequestBuilder<AttachmentDownloadV1Response> {
        ...
        let localVariableRequestBuilder: RequestBuilder<AttachmentDownloadV1Response>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
