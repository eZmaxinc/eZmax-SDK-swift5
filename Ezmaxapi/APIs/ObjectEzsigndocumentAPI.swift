...
open class ObjectEzsigndocumentAPI {
    ...
    /**
     ...
     - parameter pkiEzsigndocumentID: (path)  
     - parameter ezsigndocumentApplyEzsigntemplateV3Request: (body)  
     - parameter apiResponseQueue: The queue on which api response is dispatched.
     - parameter completion: completion handler to receive the data and the error objects
     */
    @discardableResult
    open class func ezsigndocumentApplyEzsigntemplateV3(pkiEzsigndocumentID: Int, ezsigndocumentApplyEzsigntemplateV3Request: EzsigndocumentApplyEzsigntemplateV3Request, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: EzsigndocumentApplyEzsigntemplateV3Response?, _ error: Error?) -> Void)) -> RequestTask {
        return ezsigndocumentApplyEzsigntemplateV3WithRequestBuilder(pkiEzsigndocumentID: pkiEzsigndocumentID, ezsigndocumentApplyEzsigntemplateV3Request: ezsigndocumentApplyEzsigntemplateV3Request).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     ...
     - parameter pkiEzsigndocumentID: (path)  
     - parameter ezsigndocumentApplyEzsigntemplateV3Request: (body)  
     - returns: RequestBuilder<EzsigndocumentApplyEzsigntemplateV3Response> 
     */
    open class func ezsigndocumentApplyEzsigntemplateV3WithRequestBuilder(pkiEzsigndocumentID: Int, ezsigndocumentApplyEzsigntemplateV3Request: EzsigndocumentApplyEzsigntemplateV3Request) -> RequestBuilder<EzsigndocumentApplyEzsigntemplateV3Response> {
        var localVariablePath = "/3/object/ezsigndocument/{pkiEzsigndocumentID}/applyEzsigntemplate"
        let pkiEzsigndocumentIDPreEscape = "\(APIHelper.mapValueToPathItem(pkiEzsigndocumentID))"
        let pkiEzsigndocumentIDPostEscape = pkiEzsigndocumentIDPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{pkiEzsigndocumentID}", with: pkiEzsigndocumentIDPostEscape, options: .literal, range: nil)
        let localVariableURLString = OpenAPIClientAPI.basePath + localVariablePath
        let localVariableParameters = JSONEncodingHelper.encodingParameters(forEncodableObject: ezsigndocumentApplyEzsigntemplateV3Request)
        ...
        let localVariableRequestBuilder: RequestBuilder<EzsigndocumentApplyEzsigntemplateV3Response>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
    ...
    @available(*, deprecated, message: "This operation is deprecated.")
    @discardableResult
    open class func ezsigndocumentApplyEzsigntemplateglobalV1(pkiEzsigndocumentID: Int, ezsigndocumentApplyEzsigntemplateglobalV1Request: EzsigndocumentApplyEzsigntemplateglobalV1Request, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: EzsigndocumentApplyEzsigntemplateglobalV1Response?, _ error: Error?) -> Void)) -> RequestTask {
        return ezsigndocumentApplyEzsigntemplateglobalV1WithRequestBuilder(pkiEzsigndocumentID: pkiEzsigndocumentID, ezsigndocumentApplyEzsigntemplateglobalV1Request: ezsigndocumentApplyEzsigntemplateglobalV1Request).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     ...
     - parameter pkiEzsigndocumentID: (path)  
     - parameter ezsigndocumentApplyEzsigntemplateglobalV1Request: (body)  
     - returns: RequestBuilder<EzsigndocumentApplyEzsigntemplateglobalV1Response> 
     */
    @available(*, deprecated, message: "This operation is deprecated.")
    open class func ezsigndocumentApplyEzsigntemplateglobalV1WithRequestBuilder(pkiEzsigndocumentID: Int, ezsigndocumentApplyEzsigntemplateglobalV1Request: EzsigndocumentApplyEzsigntemplateglobalV1Request) -> RequestBuilder<EzsigndocumentApplyEzsigntemplateglobalV1Response> {
        var localVariablePath = "/1/object/ezsigndocument/{pkiEzsigndocumentID}/applyEzsigntemplateglobal"
        let pkiEzsigndocumentIDPreEscape = "\(APIHelper.mapValueToPathItem(pkiEzsigndocumentID))"
        let pkiEzsigndocumentIDPostEscape = pkiEzsigndocumentIDPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{pkiEzsigndocumentID}", with: pkiEzsigndocumentIDPostEscape, options: .literal, range: nil)
        let localVariableURLString = OpenAPIClientAPI.basePath + localVariablePath
        let localVariableParameters = JSONEncodingHelper.encodingParameters(forEncodableObject: ezsigndocumentApplyEzsigntemplateglobalV1Request)
        ...
        let localVariableRequestBuilder: RequestBuilder<EzsigndocumentApplyEzsigntemplateglobalV1Response>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
    ...
    /**
     ...
     - parameter pkiEzsigndocumentID: (path)  
     - parameter ezsigndocumentApplyEzsigntemplateglobalV2Request: (body)  
     - parameter apiResponseQueue: The queue on which api response is dispatched.
     - parameter completion: completion handler to receive the data and the error objects
     */
    @discardableResult
    open class func ezsigndocumentApplyEzsigntemplateglobalV2(pkiEzsigndocumentID: Int, ezsigndocumentApplyEzsigntemplateglobalV2Request: EzsigndocumentApplyEzsigntemplateglobalV2Request, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: EzsigndocumentApplyEzsigntemplateglobalV2Response?, _ error: Error?) -> Void)) -> RequestTask {
        return ezsigndocumentApplyEzsigntemplateglobalV2WithRequestBuilder(pkiEzsigndocumentID: pkiEzsigndocumentID, ezsigndocumentApplyEzsigntemplateglobalV2Request: ezsigndocumentApplyEzsigntemplateglobalV2Request).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     ...
     - parameter pkiEzsigndocumentID: (path)  
     - parameter ezsigndocumentApplyEzsigntemplateglobalV2Request: (body)  
     - returns: RequestBuilder<EzsigndocumentApplyEzsigntemplateglobalV2Response> 
     */
    open class func ezsigndocumentApplyEzsigntemplateglobalV2WithRequestBuilder(pkiEzsigndocumentID: Int, ezsigndocumentApplyEzsigntemplateglobalV2Request: EzsigndocumentApplyEzsigntemplateglobalV2Request) -> RequestBuilder<EzsigndocumentApplyEzsigntemplateglobalV2Response> {
        var localVariablePath = "/2/object/ezsigndocument/{pkiEzsigndocumentID}/applyEzsigntemplateglobal"
        let pkiEzsigndocumentIDPreEscape = "\(APIHelper.mapValueToPathItem(pkiEzsigndocumentID))"
        let pkiEzsigndocumentIDPostEscape = pkiEzsigndocumentIDPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{pkiEzsigndocumentID}", with: pkiEzsigndocumentIDPostEscape, options: .literal, range: nil)
        let localVariableURLString = OpenAPIClientAPI.basePath + localVariablePath
        let localVariableParameters = JSONEncodingHelper.encodingParameters(forEncodableObject: ezsigndocumentApplyEzsigntemplateglobalV2Request)
        ...
        let localVariableRequestBuilder: RequestBuilder<EzsigndocumentApplyEzsigntemplateglobalV2Response>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
    ...
    open class func ezsigndocumentCreateEzsignelementsPositionedByWordV1WithRequestBuilder(pkiEzsigndocumentID: Int, ezsigndocumentCreateEzsignelementsPositionedByWordV1Request: EzsigndocumentCreateEzsignelementsPositionedByWordV1Request) -> RequestBuilder<EzsigndocumentCreateEzsignelementsPositionedByWordV1Response> {
        ...
        localVariablePath = localVariablePath.replacingOccurrences(of: "{pkiEzsigndocumentID}", with: pkiEzsigndocumentIDPostEscape, options: .literal, range: nil)
        let localVariableURLString = OpenAPIClientAPI.basePath + localVariablePath
        let localVariableParameters = JSONEncodingHelper.encodingParameters(forEncodableObject: ezsigndocumentCreateEzsignelementsPositionedByWordV1Request)
    ...
    /**
     ...
     - parameter ezsigndocumentCreateObjectV3Request: (body)  
     - parameter apiResponseQueue: The queue on which api response is dispatched.
     - parameter completion: completion handler to receive the data and the error objects
     */
    @discardableResult
    open class func ezsigndocumentCreateObjectV3(ezsigndocumentCreateObjectV3Request: EzsigndocumentCreateObjectV3Request, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: EzsigndocumentCreateObjectV3Response?, _ error: Error?) -> Void)) -> RequestTask {
        return ezsigndocumentCreateObjectV3WithRequestBuilder(ezsigndocumentCreateObjectV3Request: ezsigndocumentCreateObjectV3Request).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     ...
     - API Key:
       ...
       - name: Authorization
     - parameter ezsigndocumentCreateObjectV3Request: (body)  
     - returns: RequestBuilder<EzsigndocumentCreateObjectV3Response> 
     */
    open class func ezsigndocumentCreateObjectV3WithRequestBuilder(ezsigndocumentCreateObjectV3Request: EzsigndocumentCreateObjectV3Request) -> RequestBuilder<EzsigndocumentCreateObjectV3Response> {
        let localVariablePath = "/3/object/ezsigndocument"
        let localVariableURLString = OpenAPIClientAPI.basePath + localVariablePath
        let localVariableParameters = JSONEncodingHelper.encodingParameters(forEncodableObject: ezsigndocumentCreateObjectV3Request)
        ...
        let localVariableRequestBuilder: RequestBuilder<EzsigndocumentCreateObjectV3Response>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
    ...
    /**
     ...
     - parameter pkiEzsigndocumentID: (path)  
     - parameter ezsigndocumentEditEzsignannotationsV1Request: (body)  
     - parameter apiResponseQueue: The queue on which api response is dispatched.
     - parameter completion: completion handler to receive the data and the error objects
     */
    @discardableResult
    open class func ezsigndocumentEditEzsignannotationsV1(pkiEzsigndocumentID: Int, ezsigndocumentEditEzsignannotationsV1Request: EzsigndocumentEditEzsignannotationsV1Request, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: EzsigndocumentEditEzsignannotationsV1Response?, _ error: Error?) -> Void)) -> RequestTask {
        return ezsigndocumentEditEzsignannotationsV1WithRequestBuilder(pkiEzsigndocumentID: pkiEzsigndocumentID, ezsigndocumentEditEzsignannotationsV1Request: ezsigndocumentEditEzsignannotationsV1Request).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     ...
     - parameter pkiEzsigndocumentID: (path)  
     - parameter ezsigndocumentEditEzsignannotationsV1Request: (body)  
     - returns: RequestBuilder<EzsigndocumentEditEzsignannotationsV1Response> 
     */
    open class func ezsigndocumentEditEzsignannotationsV1WithRequestBuilder(pkiEzsigndocumentID: Int, ezsigndocumentEditEzsignannotationsV1Request: EzsigndocumentEditEzsignannotationsV1Request) -> RequestBuilder<EzsigndocumentEditEzsignannotationsV1Response> {
        var localVariablePath = "/1/object/ezsigndocument/{pkiEzsigndocumentID}/editEzsignannotations"
        let pkiEzsigndocumentIDPreEscape = "\(APIHelper.mapValueToPathItem(pkiEzsigndocumentID))"
        let pkiEzsigndocumentIDPostEscape = pkiEzsigndocumentIDPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{pkiEzsigndocumentID}", with: pkiEzsigndocumentIDPostEscape, options: .literal, range: nil)
        let localVariableURLString = OpenAPIClientAPI.basePath + localVariablePath
        let localVariableParameters = JSONEncodingHelper.encodingParameters(forEncodableObject: ezsigndocumentEditEzsignannotationsV1Request)
        ...
        let localVariableRequestBuilder: RequestBuilder<EzsigndocumentEditEzsignannotationsV1Response>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
    ...
    open class func ezsigndocumentEditEzsignformfieldgroupsV2WithRequestBuilder(pkiEzsigndocumentID: Int, ezsigndocumentEditEzsignformfieldgroupsV2Request: EzsigndocumentEditEzsignformfieldgroupsV2Request) -> RequestBuilder<EzsigndocumentEditEzsignformfieldgroupsV2Response> {
        ...
        localVariablePath = localVariablePath.replacingOccurrences(of: "{pkiEzsigndocumentID}", with: pkiEzsigndocumentIDPostEscape, options: .literal, range: nil)
        let localVariableURLString = OpenAPIClientAPI.basePath + localVariablePath
        let localVariableParameters = JSONEncodingHelper.encodingParameters(forEncodableObject: ezsigndocumentEditEzsignformfieldgroupsV2Request)
        ...
        let localVariableRequestBuilder: RequestBuilder<EzsigndocumentEditEzsignformfieldgroupsV2Response>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func ezsigndocumentEditObjectV1(pkiEzsigndocumentID: Int, ezsigndocumentEditObjectV1Request: EzsigndocumentEditObjectV1Request, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: EzsigndocumentEditObjectV1Response?, _ error: Error?) -> Void)) -> RequestTask {
        return ezsigndocumentEditObjectV1WithRequestBuilder(pkiEzsigndocumentID: pkiEzsigndocumentID, ezsigndocumentEditObjectV1Request: ezsigndocumentEditObjectV1Request).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    open class func ezsigndocumentEditObjectV1WithRequestBuilder(pkiEzsigndocumentID: Int, ezsigndocumentEditObjectV1Request: EzsigndocumentEditObjectV1Request) -> RequestBuilder<EzsigndocumentEditObjectV1Response> {
        ...
        localVariablePath = localVariablePath.replacingOccurrences(of: "{pkiEzsigndocumentID}", with: pkiEzsigndocumentIDPostEscape, options: .literal, range: nil)
        let localVariableURLString = OpenAPIClientAPI.basePath + localVariablePath
        let localVariableParameters = JSONEncodingHelper.encodingParameters(forEncodableObject: ezsigndocumentEditObjectV1Request)
        ...
        let localVariableRequestBuilder: RequestBuilder<EzsigndocumentEditObjectV1Response>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
    ...
    /**
     ...
     - parameter pkiEzsigndocumentID: (path)  
     - parameter ezsigndocumentExtractTextV1Request: (body)  
     - parameter apiResponseQueue: The queue on which api response is dispatched.
     - parameter completion: completion handler to receive the data and the error objects
     */
    @discardableResult
    open class func ezsigndocumentExtractTextV1(pkiEzsigndocumentID: Int, ezsigndocumentExtractTextV1Request: EzsigndocumentExtractTextV1Request, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: EzsigndocumentExtractTextV1Response?, _ error: Error?) -> Void)) -> RequestTask {
        return ezsigndocumentExtractTextV1WithRequestBuilder(pkiEzsigndocumentID: pkiEzsigndocumentID, ezsigndocumentExtractTextV1Request: ezsigndocumentExtractTextV1Request).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     ...
     - parameter pkiEzsigndocumentID: (path)  
     - parameter ezsigndocumentExtractTextV1Request: (body)  
     - returns: RequestBuilder<EzsigndocumentExtractTextV1Response> 
     */
    open class func ezsigndocumentExtractTextV1WithRequestBuilder(pkiEzsigndocumentID: Int, ezsigndocumentExtractTextV1Request: EzsigndocumentExtractTextV1Request) -> RequestBuilder<EzsigndocumentExtractTextV1Response> {
        var localVariablePath = "/1/object/ezsigndocument/{pkiEzsigndocumentID}/extractText"
        let pkiEzsigndocumentIDPreEscape = "\(APIHelper.mapValueToPathItem(pkiEzsigndocumentID))"
        let pkiEzsigndocumentIDPostEscape = pkiEzsigndocumentIDPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{pkiEzsigndocumentID}", with: pkiEzsigndocumentIDPostEscape, options: .literal, range: nil)
        let localVariableURLString = OpenAPIClientAPI.basePath + localVariablePath
        let localVariableParameters = JSONEncodingHelper.encodingParameters(forEncodableObject: ezsigndocumentExtractTextV1Request)
        ...
        let localVariableRequestBuilder: RequestBuilder<EzsigndocumentExtractTextV1Response>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func ezsigndocumentGetActionableElementsV3(pkiEzsigndocumentID: Int, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: EzsigndocumentGetActionableElementsV3Response?, _ error: Error?) -> Void)) -> RequestTask {
        return ezsigndocumentGetActionableElementsV3WithRequestBuilder(pkiEzsigndocumentID: pkiEzsigndocumentID).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     ...
     - API Key:
       ...
       - name: Authorization
     - parameter pkiEzsigndocumentID: (path)  
     - returns: RequestBuilder<EzsigndocumentGetActionableElementsV3Response> 
     */
    open class func ezsigndocumentGetActionableElementsV3WithRequestBuilder(pkiEzsigndocumentID: Int) -> RequestBuilder<EzsigndocumentGetActionableElementsV3Response> {
        var localVariablePath = "/3/object/ezsigndocument/{pkiEzsigndocumentID}/getActionableElements"
        let pkiEzsigndocumentIDPreEscape = "\(APIHelper.mapValueToPathItem(pkiEzsigndocumentID))"
        let pkiEzsigndocumentIDPostEscape = pkiEzsigndocumentIDPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{pkiEzsigndocumentID}", with: pkiEzsigndocumentIDPostEscape, options: .literal, range: nil)
        let localVariableURLString = OpenAPIClientAPI.basePath + localVariablePath
        ...
        let localVariableRequestBuilder: RequestBuilder<EzsigndocumentGetActionableElementsV3Response>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func ezsigndocumentGetAttachmentsV1(pkiEzsigndocumentID: Int, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: EzsigndocumentGetAttachmentsV1Response?, _ error: Error?) -> Void)) -> RequestTask {
        return ezsigndocumentGetAttachmentsV1WithRequestBuilder(pkiEzsigndocumentID: pkiEzsigndocumentID).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     ...
     - API Key:
       ...
       - name: Authorization
     - parameter pkiEzsigndocumentID: (path)  
     - returns: RequestBuilder<EzsigndocumentGetAttachmentsV1Response> 
     */
    open class func ezsigndocumentGetAttachmentsV1WithRequestBuilder(pkiEzsigndocumentID: Int) -> RequestBuilder<EzsigndocumentGetAttachmentsV1Response> {
        var localVariablePath = "/1/object/ezsigndocument/{pkiEzsigndocumentID}/getAttachments"
        let pkiEzsigndocumentIDPreEscape = "\(APIHelper.mapValueToPathItem(pkiEzsigndocumentID))"
        let pkiEzsigndocumentIDPostEscape = pkiEzsigndocumentIDPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{pkiEzsigndocumentID}", with: pkiEzsigndocumentIDPostEscape, options: .literal, range: nil)
        let localVariableURLString = OpenAPIClientAPI.basePath + localVariablePath
        ...
        let localVariableRequestBuilder: RequestBuilder<EzsigndocumentGetAttachmentsV1Response>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func ezsigndocumentGetEzsigndiscussionsV1(pkiEzsigndocumentID: Int, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: EzsigndocumentGetEzsigndiscussionsV1Response?, _ error: Error?) -> Void)) -> RequestTask {
        return ezsigndocumentGetEzsigndiscussionsV1WithRequestBuilder(pkiEzsigndocumentID: pkiEzsigndocumentID).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     ...
     - API Key:
       ...
       - name: Authorization
     - parameter pkiEzsigndocumentID: (path)  
     - returns: RequestBuilder<EzsigndocumentGetEzsigndiscussionsV1Response> 
     */
    open class func ezsigndocumentGetEzsigndiscussionsV1WithRequestBuilder(pkiEzsigndocumentID: Int) -> RequestBuilder<EzsigndocumentGetEzsigndiscussionsV1Response> {
        var localVariablePath = "/1/object/ezsigndocument/{pkiEzsigndocumentID}/getEzsigndiscussions"
        let pkiEzsigndocumentIDPreEscape = "\(APIHelper.mapValueToPathItem(pkiEzsigndocumentID))"
        let pkiEzsigndocumentIDPostEscape = pkiEzsigndocumentIDPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{pkiEzsigndocumentID}", with: pkiEzsigndocumentIDPostEscape, options: .literal, range: nil)
        let localVariableURLString = OpenAPIClientAPI.basePath + localVariablePath
        ...
        let localVariableRequestBuilder: RequestBuilder<EzsigndocumentGetEzsigndiscussionsV1Response>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
