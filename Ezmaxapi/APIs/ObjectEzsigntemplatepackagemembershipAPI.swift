...
open class ObjectEzsigntemplatepackagemembershipAPI {
     ...
     */
    @discardableResult
    open class func ezsigntemplatepackagemembershipGetObjectV3(pkiEzsigntemplatepackagemembershipID: Int, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: EzsigntemplatepackagemembershipGetObjectV3Response?, _ error: Error?) -> Void)) -> RequestTask {
        return ezsigntemplatepackagemembershipGetObjectV3WithRequestBuilder(pkiEzsigntemplatepackagemembershipID: pkiEzsigntemplatepackagemembershipID).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     ...
     - API Key:
       ...
       - name: Authorization
     - parameter pkiEzsigntemplatepackagemembershipID: (path)  
     - returns: RequestBuilder<EzsigntemplatepackagemembershipGetObjectV3Response> 
     */
    open class func ezsigntemplatepackagemembershipGetObjectV3WithRequestBuilder(pkiEzsigntemplatepackagemembershipID: Int) -> RequestBuilder<EzsigntemplatepackagemembershipGetObjectV3Response> {
        var localVariablePath = "/3/object/ezsigntemplatepackagemembership/{pkiEzsigntemplatepackagemembershipID}"
        let pkiEzsigntemplatepackagemembershipIDPreEscape = "\(APIHelper.mapValueToPathItem(pkiEzsigntemplatepackagemembershipID))"
        let pkiEzsigntemplatepackagemembershipIDPostEscape = pkiEzsigntemplatepackagemembershipIDPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{pkiEzsigntemplatepackagemembershipID}", with: pkiEzsigntemplatepackagemembershipIDPostEscape, options: .literal, range: nil)
        let localVariableURLString = OpenAPIClientAPI.basePath + localVariablePath
        ...
        let localVariableRequestBuilder: RequestBuilder<EzsigntemplatepackagemembershipGetObjectV3Response>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
