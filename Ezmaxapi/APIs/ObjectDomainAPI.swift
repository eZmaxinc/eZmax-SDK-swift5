...
open class ObjectDomainAPI {
     ...
     */
    public enum SSelector_domainGetAutocompleteV2: String, CaseIterable {
        case all = "All"
     ...
     */
    public enum EFilterActive_domainGetAutocompleteV2: String, CaseIterable {
        case all = "All"
        case active = "Active"
    ...
    /**
     ...
     - parameter sSelector: (path) The type of Domain to return 
     ...
     */
    @discardableResult
    open class func domainGetAutocompleteV2(sSelector: SSelector_domainGetAutocompleteV2, eFilterActive: EFilterActive_domainGetAutocompleteV2? = nil, sQuery: String? = nil, acceptLanguage: HeaderAcceptLanguage? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: DomainGetAutocompleteV2Response?, _ error: Error?) -> Void)) -> RequestTask {
        return domainGetAutocompleteV2WithRequestBuilder(sSelector: sSelector, eFilterActive: eFilterActive, sQuery: sQuery, acceptLanguage: acceptLanguage).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     ...
     - parameter sQuery: (query) Allow to filter the returned results (optional)
     - parameter acceptLanguage: (header)  (optional)
     - returns: RequestBuilder<DomainGetAutocompleteV2Response> 
     */
    open class func domainGetAutocompleteV2WithRequestBuilder(sSelector: SSelector_domainGetAutocompleteV2, eFilterActive: EFilterActive_domainGetAutocompleteV2? = nil, sQuery: String? = nil, acceptLanguage: HeaderAcceptLanguage? = nil) -> RequestBuilder<DomainGetAutocompleteV2Response> {
        var localVariablePath = "/2/object/domain/getAutocomplete/{sSelector}"
        ...
        let localVariableRequestBuilder: RequestBuilder<DomainGetAutocompleteV2Response>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
