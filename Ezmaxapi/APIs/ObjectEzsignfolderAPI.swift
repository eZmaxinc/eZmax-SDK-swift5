...
open class ObjectEzsignfolderAPI {
    ...
    /**
     ...
     - parameter ezsignfolderCreateObjectV3Request: (body)  
     - parameter apiResponseQueue: The queue on which api response is dispatched.
     - parameter completion: completion handler to receive the data and the error objects
     */
    @discardableResult
    open class func ezsignfolderCreateObjectV3(ezsignfolderCreateObjectV3Request: EzsignfolderCreateObjectV3Request, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: EzsignfolderCreateObjectV3Response?, _ error: Error?) -> Void)) -> RequestTask {
        return ezsignfolderCreateObjectV3WithRequestBuilder(ezsignfolderCreateObjectV3Request: ezsignfolderCreateObjectV3Request).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     ...
     - API Key:
       ...
       - name: Authorization
     - parameter ezsignfolderCreateObjectV3Request: (body)  
     - returns: RequestBuilder<EzsignfolderCreateObjectV3Response> 
     */
    open class func ezsignfolderCreateObjectV3WithRequestBuilder(ezsignfolderCreateObjectV3Request: EzsignfolderCreateObjectV3Request) -> RequestBuilder<EzsignfolderCreateObjectV3Response> {
        let localVariablePath = "/3/object/ezsignfolder"
        let localVariableURLString = OpenAPIClientAPI.basePath + localVariablePath
        let localVariableParameters = JSONEncodingHelper.encodingParameters(forEncodableObject: ezsignfolderCreateObjectV3Request)
        ...
        let localVariableRequestBuilder: RequestBuilder<EzsignfolderCreateObjectV3Response>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
    ...
    /**
     ...
     - parameter pkiEzsignfolderID: (path)  
     - parameter ezsignfolderDuplicateV1Request: (body)  
     - parameter apiResponseQueue: The queue on which api response is dispatched.
     - parameter completion: completion handler to receive the data and the error objects
     */
    @discardableResult
    open class func ezsignfolderDuplicateV1(pkiEzsignfolderID: Int, ezsignfolderDuplicateV1Request: EzsignfolderDuplicateV1Request, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: EzsignfolderDuplicateV1Response?, _ error: Error?) -> Void)) -> RequestTask {
        return ezsignfolderDuplicateV1WithRequestBuilder(pkiEzsignfolderID: pkiEzsignfolderID, ezsignfolderDuplicateV1Request: ezsignfolderDuplicateV1Request).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     ...
     - parameter pkiEzsignfolderID: (path)  
     - parameter ezsignfolderDuplicateV1Request: (body)  
     - returns: RequestBuilder<EzsignfolderDuplicateV1Response> 
     */
    open class func ezsignfolderDuplicateV1WithRequestBuilder(pkiEzsignfolderID: Int, ezsignfolderDuplicateV1Request: EzsignfolderDuplicateV1Request) -> RequestBuilder<EzsignfolderDuplicateV1Response> {
        var localVariablePath = "/1/object/ezsignfolder/{pkiEzsignfolderID}/duplicate"
        let pkiEzsignfolderIDPreEscape = "\(APIHelper.mapValueToPathItem(pkiEzsignfolderID))"
        let pkiEzsignfolderIDPostEscape = pkiEzsignfolderIDPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{pkiEzsignfolderID}", with: pkiEzsignfolderIDPostEscape, options: .literal, range: nil)
        let localVariableURLString = OpenAPIClientAPI.basePath + localVariablePath
        let localVariableParameters = JSONEncodingHelper.encodingParameters(forEncodableObject: ezsignfolderDuplicateV1Request)
        ...
        let localVariableRequestBuilder: RequestBuilder<EzsignfolderDuplicateV1Response>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
    ...
    /**
     ...
     - parameter pkiEzsignfolderID: (path)  
     - parameter ezsignfolderEditObjectV3Request: (body)  
     - parameter apiResponseQueue: The queue on which api response is dispatched.
     - parameter completion: completion handler to receive the data and the error objects
     */
    @discardableResult
    open class func ezsignfolderEditObjectV3(pkiEzsignfolderID: Int, ezsignfolderEditObjectV3Request: EzsignfolderEditObjectV3Request, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: EzsignfolderEditObjectV3Response?, _ error: Error?) -> Void)) -> RequestTask {
        return ezsignfolderEditObjectV3WithRequestBuilder(pkiEzsignfolderID: pkiEzsignfolderID, ezsignfolderEditObjectV3Request: ezsignfolderEditObjectV3Request).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     ...
     - parameter pkiEzsignfolderID: (path)  
     - parameter ezsignfolderEditObjectV3Request: (body)  
     - returns: RequestBuilder<EzsignfolderEditObjectV3Response> 
     */
    open class func ezsignfolderEditObjectV3WithRequestBuilder(pkiEzsignfolderID: Int, ezsignfolderEditObjectV3Request: EzsignfolderEditObjectV3Request) -> RequestBuilder<EzsignfolderEditObjectV3Response> {
        var localVariablePath = "/3/object/ezsignfolder/{pkiEzsignfolderID}"
        let pkiEzsignfolderIDPreEscape = "\(APIHelper.mapValueToPathItem(pkiEzsignfolderID))"
        let pkiEzsignfolderIDPostEscape = pkiEzsignfolderIDPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{pkiEzsignfolderID}", with: pkiEzsignfolderIDPostEscape, options: .literal, range: nil)
        let localVariableURLString = OpenAPIClientAPI.basePath + localVariablePath
        let localVariableParameters = JSONEncodingHelper.encodingParameters(forEncodableObject: ezsignfolderEditObjectV3Request)
        ...
        let localVariableRequestBuilder: RequestBuilder<EzsignfolderEditObjectV3Response>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func ezsignfolderEndPrematurelyV1(pkiEzsignfolderID: Int, body: AnyCodable, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: EzsignfolderEndPrematurelyV1Response?, _ error: Error?) -> Void)) -> RequestTask {
        return ezsignfolderEndPrematurelyV1WithRequestBuilder(pkiEzsignfolderID: pkiEzsignfolderID, body: body).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     ...
     - parameter pkiEzsignfolderID: (path)  
     - parameter body: (body)  
     - returns: RequestBuilder<EzsignfolderEndPrematurelyV1Response> 
     */
    open class func ezsignfolderEndPrematurelyV1WithRequestBuilder(pkiEzsignfolderID: Int, body: AnyCodable) -> RequestBuilder<EzsignfolderEndPrematurelyV1Response> {
        var localVariablePath = "/1/object/ezsignfolder/{pkiEzsignfolderID}/endPrematurely"
        let pkiEzsignfolderIDPreEscape = "\(APIHelper.mapValueToPathItem(pkiEzsignfolderID))"
        let pkiEzsignfolderIDPostEscape = pkiEzsignfolderIDPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{pkiEzsignfolderID}", with: pkiEzsignfolderIDPostEscape, options: .literal, range: nil)
        let localVariableURLString = OpenAPIClientAPI.basePath + localVariablePath
        ...
        let localVariableRequestBuilder: RequestBuilder<EzsignfolderEndPrematurelyV1Response>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
     ...
     */
    public enum ESignerType_ezsignfolderGetActionableElementsForSignerV1: String, CaseIterable {
     ...
     */
    @discardableResult
    open class func ezsignfolderGetActionableElementsForSignerV1(pkiEzsignfolderID: Int, eSignerType: ESignerType_ezsignfolderGetActionableElementsForSignerV1, fkiEzsignsignerID: Int? = nil, fkiUserID: Int? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: EzsignfolderGetActionableElementsForSignerV1Response?, _ error: Error?) -> Void)) -> RequestTask {
        return ezsignfolderGetActionableElementsForSignerV1WithRequestBuilder(pkiEzsignfolderID: pkiEzsignfolderID, eSignerType: eSignerType, fkiEzsignsignerID: fkiEzsignsignerID, fkiUserID: fkiUserID).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     ...
     - parameter fkiEzsignsignerID: (query)  (optional)
     - parameter fkiUserID: (query)  (optional)
     - returns: RequestBuilder<EzsignfolderGetActionableElementsForSignerV1Response> 
     */
    open class func ezsignfolderGetActionableElementsForSignerV1WithRequestBuilder(pkiEzsignfolderID: Int, eSignerType: ESignerType_ezsignfolderGetActionableElementsForSignerV1, fkiEzsignsignerID: Int? = nil, fkiUserID: Int? = nil) -> RequestBuilder<EzsignfolderGetActionableElementsForSignerV1Response> {
        var localVariablePath = "/1/object/ezsignfolder/{pkiEzsignfolderID}/getActionableElementsForSigner"
        let pkiEzsignfolderIDPreEscape = "\(APIHelper.mapValueToPathItem(pkiEzsignfolderID))"
        let pkiEzsignfolderIDPostEscape = pkiEzsignfolderIDPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{pkiEzsignfolderID}", with: pkiEzsignfolderIDPostEscape, options: .literal, range: nil)
        let localVariableURLString = OpenAPIClientAPI.basePath + localVariablePath
        ...
        let localVariableRequestBuilder: RequestBuilder<EzsignfolderGetActionableElementsForSignerV1Response>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
    ...
    @available(*, deprecated, message: "This operation is deprecated.")
    @discardableResult
    open class func ezsignfolderGetActionableElementsV2(pkiEzsignfolderID: Int, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: EzsignfolderGetActionableElementsV2Response?, _ error: Error?) -> Void)) -> RequestTask {
        return ezsignfolderGetActionableElementsV2WithRequestBuilder(pkiEzsignfolderID: pkiEzsignfolderID).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     ...
     - API Key:
       ...
       - name: Authorization
     - parameter pkiEzsignfolderID: (path)  
     - returns: RequestBuilder<EzsignfolderGetActionableElementsV2Response> 
     */
    @available(*, deprecated, message: "This operation is deprecated.")
    open class func ezsignfolderGetActionableElementsV2WithRequestBuilder(pkiEzsignfolderID: Int) -> RequestBuilder<EzsignfolderGetActionableElementsV2Response> {
        var localVariablePath = "/2/object/ezsignfolder/{pkiEzsignfolderID}/getActionableElements"
        let pkiEzsignfolderIDPreEscape = "\(APIHelper.mapValueToPathItem(pkiEzsignfolderID))"
        let pkiEzsignfolderIDPostEscape = pkiEzsignfolderIDPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{pkiEzsignfolderID}", with: pkiEzsignfolderIDPostEscape, options: .literal, range: nil)
        let localVariableURLString = OpenAPIClientAPI.basePath + localVariablePath
        ...
        let localVariableRequestBuilder: RequestBuilder<EzsignfolderGetActionableElementsV2Response>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func ezsignfolderGetActionableElementsV3(pkiEzsignfolderID: Int, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: EzsignfolderGetActionableElementsV3Response?, _ error: Error?) -> Void)) -> RequestTask {
        return ezsignfolderGetActionableElementsV3WithRequestBuilder(pkiEzsignfolderID: pkiEzsignfolderID).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     ...
     - API Key:
       ...
       - name: Authorization
     - parameter pkiEzsignfolderID: (path)  
     - returns: RequestBuilder<EzsignfolderGetActionableElementsV3Response> 
     */
    open class func ezsignfolderGetActionableElementsV3WithRequestBuilder(pkiEzsignfolderID: Int) -> RequestBuilder<EzsignfolderGetActionableElementsV3Response> {
        var localVariablePath = "/3/object/ezsignfolder/{pkiEzsignfolderID}/getActionableElements"
        let pkiEzsignfolderIDPreEscape = "\(APIHelper.mapValueToPathItem(pkiEzsignfolderID))"
        let pkiEzsignfolderIDPostEscape = pkiEzsignfolderIDPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{pkiEzsignfolderID}", with: pkiEzsignfolderIDPostEscape, options: .literal, range: nil)
        let localVariableURLString = OpenAPIClientAPI.basePath + localVariablePath
        ...
        let localVariableRequestBuilder: RequestBuilder<EzsignfolderGetActionableElementsV3Response>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func ezsignfolderGetCommunicationCountV1(pkiEzsignfolderID: Int, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: EzsignfolderGetCommunicationCountV1Response?, _ error: Error?) -> Void)) -> RequestTask {
        return ezsignfolderGetCommunicationCountV1WithRequestBuilder(pkiEzsignfolderID: pkiEzsignfolderID).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     ...
     - API Key:
       ...
       - name: Authorization
     - parameter pkiEzsignfolderID: (path)  
     - returns: RequestBuilder<EzsignfolderGetCommunicationCountV1Response> 
     */
    open class func ezsignfolderGetCommunicationCountV1WithRequestBuilder(pkiEzsignfolderID: Int) -> RequestBuilder<EzsignfolderGetCommunicationCountV1Response> {
        var localVariablePath = "/1/object/ezsignfolder/{pkiEzsignfolderID}/getCommunicationCount"
        let pkiEzsignfolderIDPreEscape = "\(APIHelper.mapValueToPathItem(pkiEzsignfolderID))"
        let pkiEzsignfolderIDPostEscape = pkiEzsignfolderIDPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{pkiEzsignfolderID}", with: pkiEzsignfolderIDPostEscape, options: .literal, range: nil)
        let localVariableURLString = OpenAPIClientAPI.basePath + localVariablePath
        ...
        let localVariableRequestBuilder: RequestBuilder<EzsignfolderGetCommunicationCountV1Response>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func ezsignfolderGetCommunicationListV1(pkiEzsignfolderID: Int, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: EzsignfolderGetCommunicationListV1Response?, _ error: Error?) -> Void)) -> RequestTask {
        return ezsignfolderGetCommunicationListV1WithRequestBuilder(pkiEzsignfolderID: pkiEzsignfolderID).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     ...
     - API Key:
       ...
       - name: Authorization
     - parameter pkiEzsignfolderID: (path)  
     - returns: RequestBuilder<EzsignfolderGetCommunicationListV1Response> 
     */
    open class func ezsignfolderGetCommunicationListV1WithRequestBuilder(pkiEzsignfolderID: Int) -> RequestBuilder<EzsignfolderGetCommunicationListV1Response> {
        var localVariablePath = "/1/object/ezsignfolder/{pkiEzsignfolderID}/getCommunicationList"
        let pkiEzsignfolderIDPreEscape = "\(APIHelper.mapValueToPathItem(pkiEzsignfolderID))"
        let pkiEzsignfolderIDPostEscape = pkiEzsignfolderIDPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{pkiEzsignfolderID}", with: pkiEzsignfolderIDPostEscape, options: .literal, range: nil)
        let localVariableURLString = OpenAPIClientAPI.basePath + localVariablePath
        ...
        let localVariableRequestBuilder: RequestBuilder<EzsignfolderGetCommunicationListV1Response>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func ezsignfolderGetCommunicationrecipientsV1(pkiEzsignfolderID: Int, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: EzsignfolderGetCommunicationrecipientsV1Response?, _ error: Error?) -> Void)) -> RequestTask {
        return ezsignfolderGetCommunicationrecipientsV1WithRequestBuilder(pkiEzsignfolderID: pkiEzsignfolderID).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     ...
     - API Key:
       ...
       - name: Authorization
     - parameter pkiEzsignfolderID: (path)  
     - returns: RequestBuilder<EzsignfolderGetCommunicationrecipientsV1Response> 
     */
    open class func ezsignfolderGetCommunicationrecipientsV1WithRequestBuilder(pkiEzsignfolderID: Int) -> RequestBuilder<EzsignfolderGetCommunicationrecipientsV1Response> {
        var localVariablePath = "/1/object/ezsignfolder/{pkiEzsignfolderID}/getCommunicationrecipients"
        let pkiEzsignfolderIDPreEscape = "\(APIHelper.mapValueToPathItem(pkiEzsignfolderID))"
        let pkiEzsignfolderIDPostEscape = pkiEzsignfolderIDPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{pkiEzsignfolderID}", with: pkiEzsignfolderIDPostEscape, options: .literal, range: nil)
        let localVariableURLString = OpenAPIClientAPI.basePath + localVariablePath
        ...
        let localVariableRequestBuilder: RequestBuilder<EzsignfolderGetCommunicationrecipientsV1Response>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func ezsignfolderGetCommunicationsendersV1(pkiEzsignfolderID: Int, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: EzsignfolderGetCommunicationsendersV1Response?, _ error: Error?) -> Void)) -> RequestTask {
        return ezsignfolderGetCommunicationsendersV1WithRequestBuilder(pkiEzsignfolderID: pkiEzsignfolderID).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     ...
     - API Key:
       ...
       - name: Authorization
     - parameter pkiEzsignfolderID: (path)  
     - returns: RequestBuilder<EzsignfolderGetCommunicationsendersV1Response> 
     */
    open class func ezsignfolderGetCommunicationsendersV1WithRequestBuilder(pkiEzsignfolderID: Int) -> RequestBuilder<EzsignfolderGetCommunicationsendersV1Response> {
        var localVariablePath = "/1/object/ezsignfolder/{pkiEzsignfolderID}/getCommunicationsenders"
        let pkiEzsignfolderIDPreEscape = "\(APIHelper.mapValueToPathItem(pkiEzsignfolderID))"
        let pkiEzsignfolderIDPostEscape = pkiEzsignfolderIDPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{pkiEzsignfolderID}", with: pkiEzsignfolderIDPostEscape, options: .literal, range: nil)
        let localVariableURLString = OpenAPIClientAPI.basePath + localVariablePath
        ...
        let localVariableRequestBuilder: RequestBuilder<EzsignfolderGetCommunicationsendersV1Response>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func ezsignfolderGetEzsignannotationsV1(pkiEzsignfolderID: Int, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: EzsignfolderGetEzsignannotationsV1Response?, _ error: Error?) -> Void)) -> RequestTask {
        return ezsignfolderGetEzsignannotationsV1WithRequestBuilder(pkiEzsignfolderID: pkiEzsignfolderID).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     ...
     - API Key:
       ...
       - name: Authorization
     - parameter pkiEzsignfolderID: (path)  
     - returns: RequestBuilder<EzsignfolderGetEzsignannotationsV1Response> 
     */
    open class func ezsignfolderGetEzsignannotationsV1WithRequestBuilder(pkiEzsignfolderID: Int) -> RequestBuilder<EzsignfolderGetEzsignannotationsV1Response> {
        var localVariablePath = "/1/object/ezsignfolder/{pkiEzsignfolderID}/getEzsignannotations"
        let pkiEzsignfolderIDPreEscape = "\(APIHelper.mapValueToPathItem(pkiEzsignfolderID))"
        let pkiEzsignfolderIDPostEscape = pkiEzsignfolderIDPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{pkiEzsignfolderID}", with: pkiEzsignfolderIDPostEscape, options: .literal, range: nil)
        let localVariableURLString = OpenAPIClientAPI.basePath + localVariablePath
        ...
        let localVariableRequestBuilder: RequestBuilder<EzsignfolderGetEzsignannotationsV1Response>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func ezsignfolderGetEzsigndocumentsV2(pkiEzsignfolderID: Int, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: EzsignfolderGetEzsigndocumentsV2Response?, _ error: Error?) -> Void)) -> RequestTask {
        return ezsignfolderGetEzsigndocumentsV2WithRequestBuilder(pkiEzsignfolderID: pkiEzsignfolderID).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     ...
     - API Key:
       ...
       - name: Authorization
     - parameter pkiEzsignfolderID: (path)  
     - returns: RequestBuilder<EzsignfolderGetEzsigndocumentsV2Response> 
     */
    open class func ezsignfolderGetEzsigndocumentsV2WithRequestBuilder(pkiEzsignfolderID: Int) -> RequestBuilder<EzsignfolderGetEzsigndocumentsV2Response> {
        var localVariablePath = "/2/object/ezsignfolder/{pkiEzsignfolderID}/getEzsigndocuments"
        let pkiEzsignfolderIDPreEscape = "\(APIHelper.mapValueToPathItem(pkiEzsignfolderID))"
        let pkiEzsignfolderIDPostEscape = pkiEzsignfolderIDPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{pkiEzsignfolderID}", with: pkiEzsignfolderIDPostEscape, options: .literal, range: nil)
        let localVariableURLString = OpenAPIClientAPI.basePath + localVariablePath
        ...
        let localVariableRequestBuilder: RequestBuilder<EzsignfolderGetEzsigndocumentsV2Response>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func ezsignfolderGetEzsignfoldersignerassociationsV2(pkiEzsignfolderID: Int, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: EzsignfolderGetEzsignfoldersignerassociationsV2Response?, _ error: Error?) -> Void)) -> RequestTask {
        return ezsignfolderGetEzsignfoldersignerassociationsV2WithRequestBuilder(pkiEzsignfolderID: pkiEzsignfolderID).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     ...
     - API Key:
       ...
       - name: Authorization
     - parameter pkiEzsignfolderID: (path)  
     - returns: RequestBuilder<EzsignfolderGetEzsignfoldersignerassociationsV2Response> 
     */
    open class func ezsignfolderGetEzsignfoldersignerassociationsV2WithRequestBuilder(pkiEzsignfolderID: Int) -> RequestBuilder<EzsignfolderGetEzsignfoldersignerassociationsV2Response> {
        var localVariablePath = "/2/object/ezsignfolder/{pkiEzsignfolderID}/getEzsignfoldersignerassociations"
        let pkiEzsignfolderIDPreEscape = "\(APIHelper.mapValueToPathItem(pkiEzsignfolderID))"
        let pkiEzsignfolderIDPostEscape = pkiEzsignfolderIDPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{pkiEzsignfolderID}", with: pkiEzsignfolderIDPostEscape, options: .literal, range: nil)
        let localVariableURLString = OpenAPIClientAPI.basePath + localVariablePath
        ...
        let localVariableRequestBuilder: RequestBuilder<EzsignfolderGetEzsignfoldersignerassociationsV2Response>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func ezsignfolderGetEzsignformfieldgroupsV1(pkiEzsignfolderID: Int, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: EzsignfolderGetEzsignformfieldgroupsV1Response?, _ error: Error?) -> Void)) -> RequestTask {
        return ezsignfolderGetEzsignformfieldgroupsV1WithRequestBuilder(pkiEzsignfolderID: pkiEzsignfolderID).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     ...
     - API Key:
       ...
       - name: Authorization
     - parameter pkiEzsignfolderID: (path)  
     - returns: RequestBuilder<EzsignfolderGetEzsignformfieldgroupsV1Response> 
     */
    open class func ezsignfolderGetEzsignformfieldgroupsV1WithRequestBuilder(pkiEzsignfolderID: Int) -> RequestBuilder<EzsignfolderGetEzsignformfieldgroupsV1Response> {
        var localVariablePath = "/1/object/ezsignfolder/{pkiEzsignfolderID}/getEzsignformfieldgroups"
        let pkiEzsignfolderIDPreEscape = "\(APIHelper.mapValueToPathItem(pkiEzsignfolderID))"
        let pkiEzsignfolderIDPostEscape = pkiEzsignfolderIDPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{pkiEzsignfolderID}", with: pkiEzsignfolderIDPostEscape, options: .literal, range: nil)
        let localVariableURLString = OpenAPIClientAPI.basePath + localVariablePath
        ...
        let localVariableRequestBuilder: RequestBuilder<EzsignfolderGetEzsignformfieldgroupsV1Response>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func ezsignfolderGetEzsignsignaturesAutomaticV1(pkiEzsignfolderID: Int, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: EzsignfolderGetEzsignsignaturesAutomaticV1Response?, _ error: Error?) -> Void)) -> RequestTask {
        return ezsignfolderGetEzsignsignaturesAutomaticV1WithRequestBuilder(pkiEzsignfolderID: pkiEzsignfolderID).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     ...
     - API Key:
       ...
       - name: Authorization
     - parameter pkiEzsignfolderID: (path)  
     - returns: RequestBuilder<EzsignfolderGetEzsignsignaturesAutomaticV1Response> 
     */
    open class func ezsignfolderGetEzsignsignaturesAutomaticV1WithRequestBuilder(pkiEzsignfolderID: Int) -> RequestBuilder<EzsignfolderGetEzsignsignaturesAutomaticV1Response> {
        var localVariablePath = "/1/object/ezsignfolder/{pkiEzsignfolderID}/getEzsignsignaturesAutomatic"
        let pkiEzsignfolderIDPreEscape = "\(APIHelper.mapValueToPathItem(pkiEzsignfolderID))"
        let pkiEzsignfolderIDPostEscape = pkiEzsignfolderIDPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{pkiEzsignfolderID}", with: pkiEzsignfolderIDPostEscape, options: .literal, range: nil)
        let localVariableURLString = OpenAPIClientAPI.basePath + localVariablePath
        ...
        let localVariableRequestBuilder: RequestBuilder<EzsignfolderGetEzsignsignaturesAutomaticV1Response>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
     ...
     */
    @discardableResult
    open class func ezsignfolderGetEzsignsignaturesV1(pkiEzsignfolderID: Int, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: EzsignfolderGetEzsignsignaturesV1Response?, _ error: Error?) -> Void)) -> RequestTask {
        return ezsignfolderGetEzsignsignaturesV1WithRequestBuilder(pkiEzsignfolderID: pkiEzsignfolderID).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     ...
     - API Key:
       ...
       - name: Authorization
     - parameter pkiEzsignfolderID: (path)  
     - returns: RequestBuilder<EzsignfolderGetEzsignsignaturesV1Response> 
     */
    open class func ezsignfolderGetEzsignsignaturesV1WithRequestBuilder(pkiEzsignfolderID: Int) -> RequestBuilder<EzsignfolderGetEzsignsignaturesV1Response> {
        var localVariablePath = "/1/object/ezsignfolder/{pkiEzsignfolderID}/getEzsignsignatures"
        let pkiEzsignfolderIDPreEscape = "\(APIHelper.mapValueToPathItem(pkiEzsignfolderID))"
        let pkiEzsignfolderIDPostEscape = pkiEzsignfolderIDPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{pkiEzsignfolderID}", with: pkiEzsignfolderIDPostEscape, options: .literal, range: nil)
        let localVariableURLString = OpenAPIClientAPI.basePath + localVariablePath
        ...
        let localVariableRequestBuilder: RequestBuilder<EzsignfolderGetEzsignsignaturesV1Response>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
    ...
    public enum EOrderBy_ezsignfolderGetListV1: String, CaseIterable {
        ...
        case eezsignfoldercompletionAsc = "eEzsignfolderCompletion_ASC"
        case eezsignfoldercompletionDesc = "eEzsignfolderCompletion_DESC"
        ...
        case iezsignformfieldgroupAsc = "iEzsignformfieldgroup_ASC"
        case iezsignformfieldgroupDesc = "iEzsignformfieldgroup_DESC"
        case iezsignformfieldgroupcompletedAsc = "iEzsignformfieldgroupCompleted_ASC"
        case iezsignformfieldgroupcompletedDesc = "iEzsignformfieldgroupCompleted_DESC"
        case dezsignfoldercompletedpercentageAsc = "dEzsignfolderCompletedpercentage_ASC"
        case dezsignfoldercompletedpercentageDesc = "dEzsignfolderCompletedpercentage_DESC"
        case dezsignfolderformcompletedpercentageAsc = "dEzsignfolderFormcompletedpercentage_ASC"
        case dezsignfolderformcompletedpercentageDesc = "dEzsignfolderFormcompletedpercentage_DESC"
        case dezsignfoldersignaturecompletedpercentageAsc = "dEzsignfolderSignaturecompletedpercentage_ASC"
        case dezsignfoldersignaturecompletedpercentageDesc = "dEzsignfolderSignaturecompletedpercentage_DESC"
    }
     ...
     */
    @discardableResult
    open class func ezsignfolderGetObjectV3(pkiEzsignfolderID: Int, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: EzsignfolderGetObjectV3Response?, _ error: Error?) -> Void)) -> RequestTask {
        return ezsignfolderGetObjectV3WithRequestBuilder(pkiEzsignfolderID: pkiEzsignfolderID).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     ...
     - API Key:
       ...
       - name: Authorization
     - parameter pkiEzsignfolderID: (path)  
     - returns: RequestBuilder<EzsignfolderGetObjectV3Response> 
     */
    open class func ezsignfolderGetObjectV3WithRequestBuilder(pkiEzsignfolderID: Int) -> RequestBuilder<EzsignfolderGetObjectV3Response> {
        var localVariablePath = "/3/object/ezsignfolder/{pkiEzsignfolderID}"
        let pkiEzsignfolderIDPreEscape = "\(APIHelper.mapValueToPathItem(pkiEzsignfolderID))"
        let pkiEzsignfolderIDPostEscape = pkiEzsignfolderIDPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{pkiEzsignfolderID}", with: pkiEzsignfolderIDPostEscape, options: .literal, range: nil)
        ...
        let localVariableRequestBuilder: RequestBuilder<EzsignfolderGetObjectV3Response>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
    ...
    /**
     ...
     - parameter pkiEzsignfolderID: (path)  
     - parameter ezsignfolderImportEzsigntemplatepackageV2Request: (body)  
     - parameter apiResponseQueue: The queue on which api response is dispatched.
     - parameter completion: completion handler to receive the data and the error objects
     */
    @available(*, deprecated, message: "This operation is deprecated.")
    @discardableResult
    open class func ezsignfolderImportEzsigntemplatepackageV2(pkiEzsignfolderID: Int, ezsignfolderImportEzsigntemplatepackageV2Request: EzsignfolderImportEzsigntemplatepackageV2Request, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: EzsignfolderImportEzsigntemplatepackageV2Response?, _ error: Error?) -> Void)) -> RequestTask {
        return ezsignfolderImportEzsigntemplatepackageV2WithRequestBuilder(pkiEzsignfolderID: pkiEzsignfolderID, ezsignfolderImportEzsigntemplatepackageV2Request: ezsignfolderImportEzsigntemplatepackageV2Request).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     ...
     - parameter pkiEzsignfolderID: (path)  
     - parameter ezsignfolderImportEzsigntemplatepackageV2Request: (body)  
     - returns: RequestBuilder<EzsignfolderImportEzsigntemplatepackageV2Response> 
     */
    @available(*, deprecated, message: "This operation is deprecated.")
    open class func ezsignfolderImportEzsigntemplatepackageV2WithRequestBuilder(pkiEzsignfolderID: Int, ezsignfolderImportEzsigntemplatepackageV2Request: EzsignfolderImportEzsigntemplatepackageV2Request) -> RequestBuilder<EzsignfolderImportEzsigntemplatepackageV2Response> {
        var localVariablePath = "/2/object/ezsignfolder/{pkiEzsignfolderID}/importEzsigntemplatepackage"
        let pkiEzsignfolderIDPreEscape = "\(APIHelper.mapValueToPathItem(pkiEzsignfolderID))"
        let pkiEzsignfolderIDPostEscape = pkiEzsignfolderIDPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{pkiEzsignfolderID}", with: pkiEzsignfolderIDPostEscape, options: .literal, range: nil)
        let localVariableURLString = OpenAPIClientAPI.basePath + localVariablePath
        let localVariableParameters = JSONEncodingHelper.encodingParameters(forEncodableObject: ezsignfolderImportEzsigntemplatepackageV2Request)
        ...
        let localVariableRequestBuilder: RequestBuilder<EzsignfolderImportEzsigntemplatepackageV2Response>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
    ...
    /**
     ...
     - parameter pkiEzsignfolderID: (path)  
     - parameter ezsignfolderImportEzsigntemplatepackageV3Request: (body)  
     - parameter apiResponseQueue: The queue on which api response is dispatched.
     - parameter completion: completion handler to receive the data and the error objects
     */
    @discardableResult
    open class func ezsignfolderImportEzsigntemplatepackageV3(pkiEzsignfolderID: Int, ezsignfolderImportEzsigntemplatepackageV3Request: EzsignfolderImportEzsigntemplatepackageV3Request, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: EzsignfolderImportEzsigntemplatepackageV3Response?, _ error: Error?) -> Void)) -> RequestTask {
        return ezsignfolderImportEzsigntemplatepackageV3WithRequestBuilder(pkiEzsignfolderID: pkiEzsignfolderID, ezsignfolderImportEzsigntemplatepackageV3Request: ezsignfolderImportEzsigntemplatepackageV3Request).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     ...
     - parameter pkiEzsignfolderID: (path)  
     - parameter ezsignfolderImportEzsigntemplatepackageV3Request: (body)  
     - returns: RequestBuilder<EzsignfolderImportEzsigntemplatepackageV3Response> 
     */
    open class func ezsignfolderImportEzsigntemplatepackageV3WithRequestBuilder(pkiEzsignfolderID: Int, ezsignfolderImportEzsigntemplatepackageV3Request: EzsignfolderImportEzsigntemplatepackageV3Request) -> RequestBuilder<EzsignfolderImportEzsigntemplatepackageV3Response> {
        var localVariablePath = "/3/object/ezsignfolder/{pkiEzsignfolderID}/importEzsigntemplatepackage"
        let pkiEzsignfolderIDPreEscape = "\(APIHelper.mapValueToPathItem(pkiEzsignfolderID))"
        let pkiEzsignfolderIDPostEscape = pkiEzsignfolderIDPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{pkiEzsignfolderID}", with: pkiEzsignfolderIDPostEscape, options: .literal, range: nil)
        let localVariableURLString = OpenAPIClientAPI.basePath + localVariablePath
        let localVariableParameters = JSONEncodingHelper.encodingParameters(forEncodableObject: ezsignfolderImportEzsigntemplatepackageV3Request)
        ...
        let localVariableRequestBuilder: RequestBuilder<EzsignfolderImportEzsigntemplatepackageV3Response>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
    ...
    /**
     ...
     - parameter pkiEzsignfolderID: (path)  
     - parameter ezsignfolderReorderV2Request: (body)  
     - parameter apiResponseQueue: The queue on which api response is dispatched.
     - parameter completion: completion handler to receive the data and the error objects
     */
    @discardableResult
    open class func ezsignfolderReorderV2(pkiEzsignfolderID: Int, ezsignfolderReorderV2Request: EzsignfolderReorderV2Request, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: EzsignfolderReorderV2Response?, _ error: Error?) -> Void)) -> RequestTask {
        return ezsignfolderReorderV2WithRequestBuilder(pkiEzsignfolderID: pkiEzsignfolderID, ezsignfolderReorderV2Request: ezsignfolderReorderV2Request).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     ...
     - parameter pkiEzsignfolderID: (path)  
     - parameter ezsignfolderReorderV2Request: (body)  
     - returns: RequestBuilder<EzsignfolderReorderV2Response> 
     */
    open class func ezsignfolderReorderV2WithRequestBuilder(pkiEzsignfolderID: Int, ezsignfolderReorderV2Request: EzsignfolderReorderV2Request) -> RequestBuilder<EzsignfolderReorderV2Response> {
        var localVariablePath = "/2/object/ezsignfolder/{pkiEzsignfolderID}/reorder"
        let pkiEzsignfolderIDPreEscape = "\(APIHelper.mapValueToPathItem(pkiEzsignfolderID))"
        let pkiEzsignfolderIDPostEscape = pkiEzsignfolderIDPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{pkiEzsignfolderID}", with: pkiEzsignfolderIDPostEscape, options: .literal, range: nil)
        let localVariableURLString = OpenAPIClientAPI.basePath + localVariablePath
        let localVariableParameters = JSONEncodingHelper.encodingParameters(forEncodableObject: ezsignfolderReorderV2Request)
        ...
        let localVariableRequestBuilder: RequestBuilder<EzsignfolderReorderV2Response>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
