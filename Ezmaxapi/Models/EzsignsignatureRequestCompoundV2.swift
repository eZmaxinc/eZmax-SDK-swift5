//
// EzsignsignatureRequestCompoundV2.swift
//
...
public struct EzsignsignatureRequestCompoundV2: Codable, JSONEncodable, Hashable {
    ...
    public var aObjEzsignsignaturecustomdate: [EzsignsignaturecustomdateRequestCompoundV2]?
