//
// EzsigndocumentEditEzsignannotationsV1Response.swift
//
...
public struct EzsigndocumentEditEzsignannotationsV1Response: Codable, JSONEncodable, Hashable {

    public var objDebugPayload: CommonResponseObjDebugPayload
    public var objDebug: CommonResponseObjDebug?
    public var mPayload: EzsigndocumentEditEzsignannotationsV1ResponseMPayload

    public init(objDebugPayload: CommonResponseObjDebugPayload, objDebug: CommonResponseObjDebug? = nil, mPayload: EzsigndocumentEditEzsignannotationsV1ResponseMPayload) {
