//
// UsergroupexternalmembershipResponseCompound.swift
//
...
public struct UsergroupexternalmembershipResponseCompound: Codable, JSONEncodable, Hashable {

    public static let pkiUsergroupexternalmembershipIDRule = NumericRule<Int>(minimum: 0, exclusiveMinimum: false, maximum: 65535, exclusiveMaximum: false, multipleOf: nil)
