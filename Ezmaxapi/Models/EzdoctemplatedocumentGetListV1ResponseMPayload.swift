//
// EzdoctemplatedocumentGetListV1ResponseMPayload.swift
//
...
public struct EzdoctemplatedocumentGetListV1ResponseMPayload: Codable, JSONEncodable, Hashable {

    /** The number of rows returned */
    public var iRowReturned: Int
    /** The number of rows matching your filters (if any) or the total number of rows */
    public var iRowFiltered: Int
    public var aObjEzdoctemplatedocument: [EzdoctemplatedocumentListElement]

    public init(iRowReturned: Int, iRowFiltered: Int, aObjEzdoctemplatedocument: [EzdoctemplatedocumentListElement]) {
