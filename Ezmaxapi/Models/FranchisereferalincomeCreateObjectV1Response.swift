...
public struct FranchisereferalincomeCreateObjectV1Response: Codable, JSONEncodable, Hashable {
    ...
    public init(objDebugPayload: CommonResponseObjDebugPayload, objDebug: CommonResponseObjDebug? = nil, mPayload: FranchisereferalincomeCreateObjectV1ResponseMPayload) {
