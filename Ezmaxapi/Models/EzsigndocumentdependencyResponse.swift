//
// EzsigndocumentdependencyResponse.swift
//
...
public struct EzsigndocumentdependencyResponse: Codable, JSONEncodable, Hashable {
    ...
    public init(pkiEzsigndocumentdependencyID: Int, fkiEzsigndocumentIDdependency: Int) {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encode(pkiEzsigndocumentdependencyID, forKey: .pkiEzsigndocumentdependencyID)
