//
// ElectronicfundstransferImportIntoEDMV1Response.swift
//
...
public struct ElectronicfundstransferImportIntoEDMV1Response: Codable, JSONEncodable, Hashable {

    public var objDebugPayload: CommonResponseObjDebugPayload
    public var objDebug: CommonResponseObjDebug?
    public var mPayload: ElectronicfundstransferImportIntoEDMV1ResponseMPayload

    public init(objDebugPayload: CommonResponseObjDebugPayload, objDebug: CommonResponseObjDebug? = nil, mPayload: ElectronicfundstransferImportIntoEDMV1ResponseMPayload) {
