//
// EzsigntemplatepackagesignermembershipRequestCompound.swift
//
...
public struct EzsigntemplatepackagesignermembershipRequestCompound: Codable, JSONEncodable, Hashable {

    public static let pkiEzsigntemplatepackagesignermembershipIDRule = NumericRule<Int>(minimum: 0, exclusiveMinimum: false, maximum: nil, exclusiveMaximum: false, multipleOf: nil)
    public static let fkiEzsigntemplatepackagemembershipIDRule = NumericRule<Int>(minimum: 0, exclusiveMinimum: false, maximum: nil, exclusiveMaximum: false, multipleOf: nil)
    ...
    public static let iEzsigntemplatepackagesignermembershipCopyRule = NumericRule<Int>(minimum: 1, exclusiveMinimum: false, maximum: nil, exclusiveMaximum: false, multipleOf: nil)
    ...
    public init(pkiEzsigntemplatepackagesignermembershipID: Int? = nil, fkiEzsigntemplatepackagemembershipID: Int, fkiEzsigntemplatepackagesignerID: Int, fkiEzsigntemplatesignerID: Int, iEzsigntemplatepackagesignermembershipCopy: Int? = nil) {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(pkiEzsigntemplatepackagesignermembershipID, forKey: .pkiEzsigntemplatepackagesignermembershipID)
