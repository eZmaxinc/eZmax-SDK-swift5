//
// EzsigntemplateResponseCompoundV4.swift
//
...
public struct EzsigntemplateResponseCompoundV4: Codable, JSONEncodable, Hashable {
    ...
    public var objEzsignfoldertype: CustomEzsignfoldertypeTemplateResponse?
    ...
    public var aObjEzsigntemplatesigner: [EzsigntemplatesignerResponseCompoundV3]
    public var aObjEzsigntemplateannotation: [EzsigntemplateannotationResponseCompound]?

    public init(pkiEzsigntemplateID: Int, fkiEzsigntemplatedocumentID: Int? = nil, fkiEzsignfoldertypeID: Int? = nil, objEzsignfoldertype: CustomEzsignfoldertypeTemplateResponse? = nil, fkiLanguageID: Int, fkiEzdoctemplatedocumentID: Int? = nil, sEzdoctemplatedocumentNameX: String? = nil, sLanguageNameX: String, sEzsigntemplateDescription: String, sEzsigntemplateExternaldescription: String? = nil, tEzsigntemplateComment: String? = nil, eEzsigntemplateRecognition: FieldEEzsigntemplateRecognition? = nil, sEzsigntemplateFilenameregexp: String? = nil, bEzsigntemplateAdminonly: Bool, sEzsignfoldertypeNameX: String? = nil, objAudit: CommonAudit, bEzsigntemplateEditallowed: Bool, eEzsigntemplateType: FieldEEzsigntemplateType? = nil, objEzsigntemplatedocument: EzsigntemplatedocumentResponse? = nil, aObjEzsigntemplatesigner: [EzsigntemplatesignerResponseCompoundV3], aObjEzsigntemplateannotation: [EzsigntemplateannotationResponseCompound]? = nil) {
