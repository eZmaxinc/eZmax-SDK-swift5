//
// RejectedoffertopurchaseGetCommunicationListV1Response.swift
//
...
public struct RejectedoffertopurchaseGetCommunicationListV1Response: Codable, JSONEncodable, Hashable {

    public var objDebugPayload: CommonResponseObjDebugPayloadGetList
    public var objDebug: CommonResponseObjDebug?
    public var mPayload: RejectedoffertopurchaseGetCommunicationListV1ResponseMPayload

    public init(objDebugPayload: CommonResponseObjDebugPayloadGetList, objDebug: CommonResponseObjDebug? = nil, mPayload: RejectedoffertopurchaseGetCommunicationListV1ResponseMPayload) {
