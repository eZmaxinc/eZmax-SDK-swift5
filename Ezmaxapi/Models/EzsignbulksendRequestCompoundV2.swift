//
// EzsignbulksendRequestCompoundV2.swift
//
...
public struct EzsignbulksendRequestCompoundV2: Codable, JSONEncodable, Hashable {
    ...
    public init(pkiEzsignbulksendID: Int? = nil, fkiEzsignfoldertypeID: Int, fkiLanguageID: Int, eEzsignbulksendEzsignformfieldorder: FieldEEzsignbulksendEzsignformfieldorder, sEzsignbulksendDescription: String, tEzsignbulksendNote: String, bEzsignbulksendNeedvalidation: Bool, bEzsignbulksendIsactive: Bool) {
