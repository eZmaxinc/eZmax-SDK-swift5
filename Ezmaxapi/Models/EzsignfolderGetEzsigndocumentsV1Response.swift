...
public struct EzsignfolderGetEzsigndocumentsV1Response: Codable, JSONEncodable, Hashable {
    ...
    public init(objDebugPayload: CommonResponseObjDebugPayload, objDebug: CommonResponseObjDebug? = nil, mPayload: EzsignfolderGetEzsigndocumentsV1ResponseMPayload) {
