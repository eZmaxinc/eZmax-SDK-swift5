//
// UsergroupexternalGetAutocompleteV2Response.swift
//
...
public struct UsergroupexternalGetAutocompleteV2Response: Codable, JSONEncodable, Hashable {

    public var objDebugPayload: CommonResponseObjDebugPayload
    public var objDebug: CommonResponseObjDebug?
    public var mPayload: UsergroupexternalGetAutocompleteV2ResponseMPayload

    public init(objDebugPayload: CommonResponseObjDebugPayload, objDebug: CommonResponseObjDebug? = nil, mPayload: UsergroupexternalGetAutocompleteV2ResponseMPayload) {
