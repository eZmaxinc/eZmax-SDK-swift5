//
// EzmaxinvoicingcontractResponse.swift
//
...
public struct EzmaxinvoicingcontractResponse: Codable, JSONEncodable, Hashable {
    ...
    public static let pkiEzmaxinvoicingcontractIDRule = NumericRule<Int>(minimum: 1, exclusiveMinimum: false, maximum: nil, exclusiveMaximum: false, multipleOf: nil)
    ...
    public static let dEzmaxinvoicingcontractLicenseRule = StringRule(minLength: nil, maxLength: nil, pattern: "/^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/")
    public static let dEzmaxinvoicingcontract121qaRule = StringRule(minLength: nil, maxLength: nil, pattern: "/^-{0,1}[\\d]{1,9}?\\.[\\d]{2}$/")
