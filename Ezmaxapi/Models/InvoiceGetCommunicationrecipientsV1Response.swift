//
// InvoiceGetCommunicationrecipientsV1Response.swift
//
...
public struct InvoiceGetCommunicationrecipientsV1Response: Codable, JSONEncodable, Hashable {

    public var objDebugPayload: CommonResponseObjDebugPayload
    public var objDebug: CommonResponseObjDebug?
    public var mPayload: InvoiceGetCommunicationrecipientsV1ResponseMPayload

    public init(objDebugPayload: CommonResponseObjDebugPayload, objDebug: CommonResponseObjDebug? = nil, mPayload: InvoiceGetCommunicationrecipientsV1ResponseMPayload) {
