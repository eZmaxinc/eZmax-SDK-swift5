//
// AdjustmentGetCommunicationrecipientsV1Response.swift
//
...
public struct AdjustmentGetCommunicationrecipientsV1Response: Codable, JSONEncodable, Hashable {

    public var objDebugPayload: CommonResponseObjDebugPayload
    public var objDebug: CommonResponseObjDebug?
    public var mPayload: AdjustmentGetCommunicationrecipientsV1ResponseMPayload

    public init(objDebugPayload: CommonResponseObjDebugPayload, objDebug: CommonResponseObjDebug? = nil, mPayload: AdjustmentGetCommunicationrecipientsV1ResponseMPayload) {
