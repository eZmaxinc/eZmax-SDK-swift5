//
// EzsignfolderGetActionableElementsV3Response.swift
//
...
public struct EzsignfolderGetActionableElementsV3Response: Codable, JSONEncodable, Hashable {

    public var objDebugPayload: CommonResponseObjDebugPayload
    public var objDebug: CommonResponseObjDebug?
    public var mPayload: EzsignfolderGetActionableElementsV3ResponseMPayload

    public init(objDebugPayload: CommonResponseObjDebugPayload, objDebug: CommonResponseObjDebug? = nil, mPayload: EzsignfolderGetActionableElementsV3ResponseMPayload) {
