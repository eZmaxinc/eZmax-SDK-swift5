//
// InscriptionGetCommunicationrecipientsV1Response.swift
//
...
public struct InscriptionGetCommunicationrecipientsV1Response: Codable, JSONEncodable, Hashable {

    public var objDebugPayload: CommonResponseObjDebugPayload
    public var objDebug: CommonResponseObjDebug?
    public var mPayload: InscriptionGetCommunicationrecipientsV1ResponseMPayload

    public init(objDebugPayload: CommonResponseObjDebugPayload, objDebug: CommonResponseObjDebug? = nil, mPayload: InscriptionGetCommunicationrecipientsV1ResponseMPayload) {
