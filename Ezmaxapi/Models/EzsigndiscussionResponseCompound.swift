//
// EzsigndiscussionResponseCompound.swift
//
...
public struct EzsigndiscussionResponseCompound: Codable, JSONEncodable, Hashable {
    ...
    public static let fkiEzsignpageIDRule = NumericRule<Int>(minimum: 0, exclusiveMinimum: false, maximum: nil, exclusiveMaximum: false, multipleOf: nil)
