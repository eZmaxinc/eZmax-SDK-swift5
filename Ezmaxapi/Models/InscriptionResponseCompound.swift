...
public struct InscriptionResponseCompound: Codable, JSONEncodable, Hashable {
    ...
    public static let tInscriptionCadastreRule = StringRule(minLength: nil, maxLength: nil, pattern: "/^.{0,16777215}$/")
    public static let tInscriptionChecklistnoteRule = StringRule(minLength: nil, maxLength: nil, pattern: "/^.{0,16777215}$/")
