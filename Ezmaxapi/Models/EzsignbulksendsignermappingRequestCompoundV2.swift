//
// EzsignbulksendsignermappingRequestCompoundV2.swift
//
...
public struct EzsignbulksendsignermappingRequestCompoundV2: Codable, JSONEncodable, Hashable {
    ...
    public var eEzsignbulksendsignermappingRole: FieldEEzsignbulksendsignermappingRole?
    /** The description of the Ezsignbulksendsignermapping */
    public var sEzsignbulksendsignermappingDescription: String

    public init(pkiEzsignbulksendsignermappingID: Int? = nil, fkiEzsignbulksendID: Int, fkiUserID: Int? = nil, eEzsignbulksendsignermappingRole: FieldEEzsignbulksendsignermappingRole? = nil, sEzsignbulksendsignermappingDescription: String) {
        self.pkiEzsignbulksendsignermappingID = pkiEzsignbulksendsignermappingID
        self.fkiEzsignbulksendID = fkiEzsignbulksendID
        self.fkiUserID = fkiUserID
        self.eEzsignbulksendsignermappingRole = eEzsignbulksendsignermappingRole
    ...
    public enum CodingKeys: String, CodingKey, CaseIterable {
        ...
        case fkiUserID
        case eEzsignbulksendsignermappingRole
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(eEzsignbulksendsignermappingRole, forKey: .eEzsignbulksendsignermappingRole)
