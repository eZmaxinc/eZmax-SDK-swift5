//
// EzmaxinvoicinguserResponse.swift
//
...
public struct EzmaxinvoicinguserResponse: Codable, JSONEncodable, Hashable {

    public static let pkiEzmaxinvoicinguserIDRule = NumericRule<Int>(minimum: 0, exclusiveMinimum: false, maximum: nil, exclusiveMaximum: false, multipleOf: nil)
    ...
    public static let iEzmaxinvoicinguserEzsigndocumentRule = NumericRule<Int>(minimum: 0, exclusiveMinimum: false, maximum: nil, exclusiveMaximum: false, multipleOf: nil)
    ...
    public init(pkiEzmaxinvoicinguserID: Int? = nil, fkiEzmaxinvoicingID: Int? = nil, fkiBillingentityinternalID: Int, sBillingentityinternalDescriptionX: String, fkiUserID: Int, iEzmaxinvoicinguserEzsigndocument: Int, bEzmaxinvoicinguserEzsignaccount: Bool, bEzmaxinvoicinguserBillableezsign: Bool, eEzmaxinvoicinguserVariationezsign: FieldEEzmaxinvoicinguserVariationezsign) {
