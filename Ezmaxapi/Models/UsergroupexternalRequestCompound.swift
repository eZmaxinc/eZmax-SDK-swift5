//
// UsergroupexternalRequestCompound.swift
//
...
public struct UsergroupexternalRequestCompound: Codable, JSONEncodable, Hashable {
    ...
    public init(pkiUsergroupexternalID: Int? = nil, sUsergroupexternalName: String, sUsergroupexternalID: String) {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(pkiUsergroupexternalID, forKey: .pkiUsergroupexternalID)
