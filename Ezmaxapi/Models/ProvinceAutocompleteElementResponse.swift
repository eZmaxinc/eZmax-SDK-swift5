...
public struct ProvinceAutocompleteElementResponse: Codable, JSONEncodable, Hashable {
    ...
    static let pkiProvinceIDRule = NumericRule<Int>(minimum: 0, exclusiveMinimum: false, maximum: nil, exclusiveMaximum: false, multipleOf: nil)
    ...
    static let sProvinceShortnameRule = StringRule(minLength: nil, maxLength: nil, pattern: "/^.{1,3}$/")
