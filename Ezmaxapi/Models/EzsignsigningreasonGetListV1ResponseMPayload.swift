//
// EzsignsigningreasonGetListV1ResponseMPayload.swift
//
...
public struct EzsignsigningreasonGetListV1ResponseMPayload: Codable, JSONEncodable, Hashable {

    /** The number of rows returned */
    public var iRowReturned: Int
    /** The number of rows matching your filters (if any) or the total number of rows */
    public var iRowFiltered: Int
    public var aObjEzsignsigningreason: [EzsignsigningreasonListElement]

    public init(iRowReturned: Int, iRowFiltered: Int, aObjEzsignsigningreason: [EzsignsigningreasonListElement]) {
