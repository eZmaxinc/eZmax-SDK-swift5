...
public struct FranchiseofficeGetAutocompleteV2Response: Codable, JSONEncodable, Hashable {
    ...
    public init(objDebugPayload: CommonResponseObjDebugPayload, objDebug: CommonResponseObjDebug? = nil, mPayload: FranchiseofficeGetAutocompleteV2ResponseMPayload) {
