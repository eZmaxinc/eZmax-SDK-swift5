//
// DeposittransitchequeImportIntoEDMV1Response.swift
//
...
public struct DeposittransitchequeImportIntoEDMV1Response: Codable, JSONEncodable, Hashable {

    public var objDebugPayload: CommonResponseObjDebugPayload
    public var objDebug: CommonResponseObjDebug?
    public var mPayload: DeposittransitchequeImportIntoEDMV1ResponseMPayload

    public init(objDebugPayload: CommonResponseObjDebugPayload, objDebug: CommonResponseObjDebug? = nil, mPayload: DeposittransitchequeImportIntoEDMV1ResponseMPayload) {
