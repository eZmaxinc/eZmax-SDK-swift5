...
public struct FranchisebrokerGetAutocompleteV2Response: Codable, JSONEncodable, Hashable {
    ...
    public init(objDebugPayload: CommonResponseObjDebugPayload, objDebug: CommonResponseObjDebug? = nil, mPayload: FranchisebrokerGetAutocompleteV2ResponseMPayload) {
