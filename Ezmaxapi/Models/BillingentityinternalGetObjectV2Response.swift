...
public struct BillingentityinternalGetObjectV2Response: Codable, JSONEncodable, Hashable {
    ...
    public init(objDebugPayload: CommonResponseObjDebugPayload, objDebug: CommonResponseObjDebug? = nil, mPayload: BillingentityinternalGetObjectV2ResponseMPayload) {
