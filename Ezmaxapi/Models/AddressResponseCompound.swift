...
public struct AddressResponseCompound: Codable, JSONEncodable, Hashable {
    ...
    static let sProvinceNameXRule = StringRule(minLength: nil, maxLength: nil, pattern: "/^.{0,50}$/")
    ...
    public init(pkiAddressID: Int, fkiAddresstypeID: Int, sAddressCivic: String, sAddressStreet: String, sAddressSuite: String? = nil, sAddressCity: String, fkiProvinceID: Int, sProvinceNameX: String, fkiCountryID: Int, sCountryNameX: String, sAddressZip: String, fAddressLongitude: String? = nil, fAddressLatitude: String? = nil) {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encode(pkiAddressID, forKey: .pkiAddressID)
