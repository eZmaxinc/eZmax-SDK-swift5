...
public struct EzsigntemplateformfieldgroupGetObjectV2Response: Codable, JSONEncodable, Hashable {
    ...
    public init(objDebugPayload: CommonResponseObjDebugPayload, objDebug: CommonResponseObjDebug? = nil, mPayload: EzsigntemplateformfieldgroupGetObjectV2ResponseMPayload) {
