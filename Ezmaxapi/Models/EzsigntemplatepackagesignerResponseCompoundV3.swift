//
// EzsigntemplatepackagesignerResponseCompoundV3.swift
//
...
public struct EzsigntemplatepackagesignerResponseCompoundV3: Codable, JSONEncodable, Hashable {
    ...
    public init(pkiEzsigntemplatepackagesignerID: Int, fkiEzsigntemplatepackageID: Int, fkiEzdoctemplatedocumentID: Int? = nil, fkiUserID: Int? = nil, fkiUsergroupID: Int? = nil, sEzdoctemplatedocumentNameX: String? = nil, eEzsigntemplatepackagesignerRole: FieldEEzsigntemplatepackagesignerRole? = nil, eEzsigntemplatepackagesignerMapping: FieldEEzsigntemplatepackagesignerMapping? = nil, sEzsigntemplatepackagesignerDescription: String, sUserName: String? = nil, sUsergroupNameX: String? = nil) {
