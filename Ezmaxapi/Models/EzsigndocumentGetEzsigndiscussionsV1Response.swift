//
// EzsigndocumentGetEzsigndiscussionsV1Response.swift
//
...
public struct EzsigndocumentGetEzsigndiscussionsV1Response: Codable, JSONEncodable, Hashable {

    public var objDebugPayload: CommonResponseObjDebugPayload
    public var objDebug: CommonResponseObjDebug?
    public var mPayload: EzsigndocumentGetEzsigndiscussionsV1ResponseMPayload

    public init(objDebugPayload: CommonResponseObjDebugPayload, objDebug: CommonResponseObjDebug? = nil, mPayload: EzsigndocumentGetEzsigndiscussionsV1ResponseMPayload) {
