//
// EzsignfoldertypeResponseCompound.swift
//
...
public struct EzsignfoldertypeResponseCompound: Codable, JSONEncodable, Hashable {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(eEzsignfoldertypeCompletion, forKey: .eEzsignfoldertypeCompletion)
