//
// ElectronicfundstransferGetCommunicationListV1Response.swift
//
...
public struct ElectronicfundstransferGetCommunicationListV1Response: Codable, JSONEncodable, Hashable {

    public var objDebugPayload: CommonResponseObjDebugPayloadGetList
    public var objDebug: CommonResponseObjDebug?
    public var mPayload: ElectronicfundstransferGetCommunicationListV1ResponseMPayload

    public init(objDebugPayload: CommonResponseObjDebugPayloadGetList, objDebug: CommonResponseObjDebug? = nil, mPayload: ElectronicfundstransferGetCommunicationListV1ResponseMPayload) {
