//
// BuyercontractGetCommunicationsendersV1Response.swift
//
...
public struct BuyercontractGetCommunicationsendersV1Response: Codable, JSONEncodable, Hashable {

    public var objDebugPayload: CommonResponseObjDebugPayload
    public var objDebug: CommonResponseObjDebug?
    public var mPayload: BuyercontractGetCommunicationsendersV1ResponseMPayload

    public init(objDebugPayload: CommonResponseObjDebugPayload, objDebug: CommonResponseObjDebug? = nil, mPayload: BuyercontractGetCommunicationsendersV1ResponseMPayload) {
