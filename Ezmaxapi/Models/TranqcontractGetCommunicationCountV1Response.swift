//
// TranqcontractGetCommunicationCountV1Response.swift
//
...
public struct TranqcontractGetCommunicationCountV1Response: Codable, JSONEncodable, Hashable {

    public var objDebugPayload: CommonResponseObjDebugPayload
    public var objDebug: CommonResponseObjDebug?
    public var mPayload: TranqcontractGetCommunicationCountV1ResponseMPayload

    public init(objDebugPayload: CommonResponseObjDebugPayload, objDebug: CommonResponseObjDebug? = nil, mPayload: TranqcontractGetCommunicationCountV1ResponseMPayload) {
