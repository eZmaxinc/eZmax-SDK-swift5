...
public struct UsergroupGetUsergroupmembershipsV1Response: Codable, JSONEncodable, Hashable {
    ...
    public init(objDebugPayload: CommonResponseObjDebugPayload, objDebug: CommonResponseObjDebug? = nil, mPayload: UsergroupGetUsergroupmembershipsV1ResponseMPayload) {
