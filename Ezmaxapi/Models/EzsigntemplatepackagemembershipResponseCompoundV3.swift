//
// EzsigntemplatepackagemembershipResponseCompoundV3.swift
//
...
public struct EzsigntemplatepackagemembershipResponseCompoundV3: Codable, JSONEncodable, Hashable {
    ...
    public init(pkiEzsigntemplatepackagemembershipID: Int, fkiEzsigntemplatepackageID: Int, fkiEzsigntemplateID: Int, iEzsigntemplatepackagemembershipOrder: Int, objEzsigntemplate: EzsigntemplateResponseCompoundV4, aObjEzsigntemplatepackagesignermembership: [EzsigntemplatepackagesignermembershipResponseCompound]) {
