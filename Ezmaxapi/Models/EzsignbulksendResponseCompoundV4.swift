//
// EzsignbulksendResponseCompoundV4.swift
//
...
public struct EzsignbulksendResponseCompoundV4: Codable, JSONEncodable, Hashable {

    public static let pkiEzsignbulksendIDRule = NumericRule<Int>(minimum: 0, exclusiveMinimum: false, maximum: nil, exclusiveMaximum: false, multipleOf: nil)
    ...
    public var eEzsignbulksendEzsignformfieldorder: FieldEEzsignbulksendEzsignformfieldorder
    ...
    public var aObjEzsignbulksenddocumentmapping: [EzsignbulksenddocumentmappingResponseCompoundV3]
    public var aObjEzsignbulksendsignermapping: [EzsignbulksendsignermappingResponseV3]

    public init(pkiEzsignbulksendID: Int, fkiEzsignfoldertypeID: Int, fkiLanguageID: Int, sLanguageNameX: String, eEzsignbulksendEzsignformfieldorder: FieldEEzsignbulksendEzsignformfieldorder, eEzsignfoldertypePrivacylevel: FieldEEzsignfoldertypePrivacylevel, sEzsignfoldertypeNameX: String, sEzsignbulksendDescription: String, tEzsignbulksendNote: String, bEzsignbulksendNeedvalidation: Bool, bEzsignbulksendIsactive: Bool, objAudit: CommonAudit, aObjEzsignbulksenddocumentmapping: [EzsignbulksenddocumentmappingResponseCompoundV3], aObjEzsignbulksendsignermapping: [EzsignbulksendsignermappingResponseV3]) {
        self.pkiEzsignbulksendID = pkiEzsignbulksendID
        self.fkiEzsignfoldertypeID = fkiEzsignfoldertypeID
        self.fkiLanguageID = fkiLanguageID
        self.sLanguageNameX = sLanguageNameX
        self.eEzsignbulksendEzsignformfieldorder = eEzsignbulksendEzsignformfieldorder
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encode(eEzsignbulksendEzsignformfieldorder, forKey: .eEzsignbulksendEzsignformfieldorder)
