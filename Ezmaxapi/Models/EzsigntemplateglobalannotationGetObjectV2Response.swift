//
// EzsigntemplateglobalannotationGetObjectV2Response.swift
//
...
public struct EzsigntemplateglobalannotationGetObjectV2Response: Codable, JSONEncodable, Hashable {

    public var objDebugPayload: CommonResponseObjDebugPayload
    public var objDebug: CommonResponseObjDebug?
    public var mPayload: EzsigntemplateglobalannotationGetObjectV2ResponseMPayload

    public init(objDebugPayload: CommonResponseObjDebugPayload, objDebug: CommonResponseObjDebug? = nil, mPayload: EzsigntemplateglobalannotationGetObjectV2ResponseMPayload) {
