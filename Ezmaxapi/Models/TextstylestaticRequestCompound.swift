//
// TextstylestaticRequestCompound.swift
//
...
public struct TextstylestaticRequestCompound: Codable, JSONEncodable, Hashable {
    ...
    public init(fkiFontID: Int, bTextstylestaticBold: Bool, bTextstylestaticUnderline: Bool, bTextstylestaticItalic: Bool, bTextstylestaticStrikethrough: Bool, iTextstylestaticFontcolor: Int, iTextstylestaticSize: Int) {
