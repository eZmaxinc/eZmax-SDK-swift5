//
// ElectronicfundstransferGetCommunicationsendersV1Response.swift
//
...
public struct ElectronicfundstransferGetCommunicationsendersV1Response: Codable, JSONEncodable, Hashable {
    ...
    public var mPayload: ElectronicfundstransferGetCommunicationsendersV1ResponseMPayload

    public init(objDebugPayload: CommonResponseObjDebugPayload, objDebug: CommonResponseObjDebug? = nil, mPayload: ElectronicfundstransferGetCommunicationsendersV1ResponseMPayload) {
