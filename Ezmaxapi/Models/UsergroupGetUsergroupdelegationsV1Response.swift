//
// UsergroupGetUsergroupdelegationsV1Response.swift
//
...
public struct UsergroupGetUsergroupdelegationsV1Response: Codable, JSONEncodable, Hashable {

    public var objDebugPayload: CommonResponseObjDebugPayload
    public var objDebug: CommonResponseObjDebug?
    public var mPayload: UsergroupGetUsergroupdelegationsV1ResponseMPayload

    public init(objDebugPayload: CommonResponseObjDebugPayload, objDebug: CommonResponseObjDebug? = nil, mPayload: UsergroupGetUsergroupdelegationsV1ResponseMPayload) {
