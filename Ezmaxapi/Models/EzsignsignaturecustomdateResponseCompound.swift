//
// EzsignsignaturecustomdateResponseCompound.swift
//
...
public struct EzsignsignaturecustomdateResponseCompound: Codable, JSONEncodable, Hashable {
    ...
    public static let iEzsignsignaturecustomdateXRule = NumericRule<Int>(minimum: 0, exclusiveMinimum: false, maximum: nil, exclusiveMaximum: false, multipleOf: nil)
    public static let iEzsignsignaturecustomdateYRule = NumericRule<Int>(minimum: 0, exclusiveMinimum: false, maximum: nil, exclusiveMaximum: false, multipleOf: nil)
    ...
    public init(pkiEzsignsignaturecustomdateID: Int, iEzsignsignaturecustomdateX: Int? = nil, iEzsignsignaturecustomdateY: Int? = nil, iEzsignsignaturecustomdateOffsetx: Int? = nil, iEzsignsignaturecustomdateOffsety: Int? = nil, sEzsignsignaturecustomdateFormat: String) {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encode(pkiEzsignsignaturecustomdateID, forKey: .pkiEzsignsignaturecustomdateID)
