//
// OtherincomeGetCommunicationListV1Response.swift
//
...
public struct OtherincomeGetCommunicationListV1Response: Codable, JSONEncodable, Hashable {

    public var objDebugPayload: CommonResponseObjDebugPayloadGetList
    public var objDebug: CommonResponseObjDebug?
    public var mPayload: OtherincomeGetCommunicationListV1ResponseMPayload

    public init(objDebugPayload: CommonResponseObjDebugPayloadGetList, objDebug: CommonResponseObjDebug? = nil, mPayload: OtherincomeGetCommunicationListV1ResponseMPayload) {
