//
// EzsignsignaturecustomdateResponseCompoundV2.swift
//
...
public struct EzsignsignaturecustomdateResponseCompoundV2: Codable, JSONEncodable, Hashable {
    ...
    public init(pkiEzsignsignaturecustomdateID: Int, iEzsignsignaturecustomdateOffsetx: Int, iEzsignsignaturecustomdateOffsety: Int, sEzsignsignaturecustomdateFormat: String) {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encode(iEzsignsignaturecustomdateOffsetx, forKey: .iEzsignsignaturecustomdateOffsetx)
        try container.encode(iEzsignsignaturecustomdateOffsety, forKey: .iEzsignsignaturecustomdateOffsety)
