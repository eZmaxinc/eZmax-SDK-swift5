//
// OtherincomeGetCommunicationCountV1Response.swift
//
...
public struct OtherincomeGetCommunicationCountV1Response: Codable, JSONEncodable, Hashable {

    public var objDebugPayload: CommonResponseObjDebugPayload
    public var objDebug: CommonResponseObjDebug?
    public var mPayload: OtherincomeGetCommunicationCountV1ResponseMPayload

    public init(objDebugPayload: CommonResponseObjDebugPayload, objDebug: CommonResponseObjDebug? = nil, mPayload: OtherincomeGetCommunicationCountV1ResponseMPayload) {
