//
// RejectedoffertopurchaseGetListV1Response.swift
//
...
public struct RejectedoffertopurchaseGetListV1Response: Codable, JSONEncodable, Hashable {

    public var objDebugPayload: CommonResponseObjDebugPayloadGetList
    public var objDebug: CommonResponseObjDebug?
    public var mPayload: RejectedoffertopurchaseGetListV1ResponseMPayload

    public init(objDebugPayload: CommonResponseObjDebugPayloadGetList, objDebug: CommonResponseObjDebug? = nil, mPayload: RejectedoffertopurchaseGetListV1ResponseMPayload) {
