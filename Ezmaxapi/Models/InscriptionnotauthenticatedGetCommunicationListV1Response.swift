//
// InscriptionnotauthenticatedGetCommunicationListV1Response.swift
//
...
public struct InscriptionnotauthenticatedGetCommunicationListV1Response: Codable, JSONEncodable, Hashable {

    public var objDebugPayload: CommonResponseObjDebugPayloadGetList
    public var objDebug: CommonResponseObjDebug?
    public var mPayload: InscriptionnotauthenticatedGetCommunicationListV1ResponseMPayload

    public init(objDebugPayload: CommonResponseObjDebugPayloadGetList, objDebug: CommonResponseObjDebug? = nil, mPayload: InscriptionnotauthenticatedGetCommunicationListV1ResponseMPayload) {
