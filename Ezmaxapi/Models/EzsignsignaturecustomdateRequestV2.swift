//
// EzsignsignaturecustomdateRequestV2.swift
//
...
public struct EzsignsignaturecustomdateRequestV2: Codable, JSONEncodable, Hashable {
    ...
    public init(pkiEzsignsignaturecustomdateID: Int? = nil, iEzsignsignaturecustomdateOffsetx: Int, iEzsignsignaturecustomdateOffsety: Int, sEzsignsignaturecustomdateFormat: String) {
