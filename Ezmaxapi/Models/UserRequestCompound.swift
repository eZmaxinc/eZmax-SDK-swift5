...
public struct UserRequestCompound: Codable, JSONEncodable, Hashable {
    ...
    public var objPhoneHome: PhoneRequest?
    /** A Phone Object and children to create a complete structure */
    public var objPhoneSMS: PhoneRequest?
