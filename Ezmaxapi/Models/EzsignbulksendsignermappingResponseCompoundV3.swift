//
// EzsignbulksendsignermappingResponseCompoundV3.swift
//
...
public struct EzsignbulksendsignermappingResponseCompoundV3: Codable, JSONEncodable, Hashable {
    ...
    public init(pkiEzsignbulksendsignermappingID: Int, fkiEzsignbulksendID: Int, fkiUserID: Int? = nil, eEzsignbulksendsignermappingRole: FieldEEzsignbulksendsignermappingRole? = nil, sEzsignbulksendsignermappingDescription: String) {
