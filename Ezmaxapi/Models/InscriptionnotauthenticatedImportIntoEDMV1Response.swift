//
// InscriptionnotauthenticatedImportIntoEDMV1Response.swift
//
...
public struct InscriptionnotauthenticatedImportIntoEDMV1Response: Codable, JSONEncodable, Hashable {

    public var objDebugPayload: CommonResponseObjDebugPayload
    public var objDebug: CommonResponseObjDebug?
    public var mPayload: InscriptionnotauthenticatedImportIntoEDMV1ResponseMPayload

    public init(objDebugPayload: CommonResponseObjDebugPayload, objDebug: CommonResponseObjDebug? = nil, mPayload: InscriptionnotauthenticatedImportIntoEDMV1ResponseMPayload) {
