//
// EzsignsignerRequestCompound.swift
//
...
public struct EzsignsignerRequestCompound: Codable, JSONEncodable, Hashable {
    ...
    public init(fkiUserlogintypeID: Int? = nil, fkiTaxassignmentID: Int, fkiSecretquestionID: Int? = nil, eEzsignsignerLogintype: EEzsignsignerLogintype? = nil, sEzsignsignerSecretanswer: String? = nil, objContact: EzsignsignerRequestCompoundContact) {
