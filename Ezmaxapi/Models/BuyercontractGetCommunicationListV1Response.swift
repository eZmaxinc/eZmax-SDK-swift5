//
// BuyercontractGetCommunicationListV1Response.swift
//
...
public struct BuyercontractGetCommunicationListV1Response: Codable, JSONEncodable, Hashable {

    public var objDebugPayload: CommonResponseObjDebugPayloadGetList
    public var objDebug: CommonResponseObjDebug?
    public var mPayload: BuyercontractGetCommunicationListV1ResponseMPayload

    public init(objDebugPayload: CommonResponseObjDebugPayloadGetList, objDebug: CommonResponseObjDebug? = nil, mPayload: BuyercontractGetCommunicationListV1ResponseMPayload) {
