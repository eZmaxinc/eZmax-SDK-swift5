//
// ContactinformationsRequestCompoundV2.swift
//
...
public struct ContactinformationsRequestCompoundV2: Codable, JSONEncodable, Hashable {
    ...
    public init(eContactinformationsType: FieldEContactinformationsType, iAddressDefault: Int, iPhoneDefault: Int, iEmailDefault: Int, iWebsiteDefault: Int, aObjAddress: [AddressRequestCompound], aObjPhone: [PhoneRequestCompound], aObjEmail: [EmailRequestCompound], aObjWebsite: [WebsiteRequestCompound]) {
