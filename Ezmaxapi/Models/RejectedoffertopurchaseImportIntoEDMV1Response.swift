//
// RejectedoffertopurchaseImportIntoEDMV1Response.swift
//
...
public struct RejectedoffertopurchaseImportIntoEDMV1Response: Codable, JSONEncodable, Hashable {

    public var objDebugPayload: CommonResponseObjDebugPayload
    public var objDebug: CommonResponseObjDebug?
    public var mPayload: RejectedoffertopurchaseImportIntoEDMV1ResponseMPayload

    public init(objDebugPayload: CommonResponseObjDebugPayload, objDebug: CommonResponseObjDebug? = nil, mPayload: RejectedoffertopurchaseImportIntoEDMV1ResponseMPayload) {
