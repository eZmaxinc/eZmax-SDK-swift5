//
// EzsigntemplatesignatureGetObjectV4Response.swift
//
...
public struct EzsigntemplatesignatureGetObjectV4Response: Codable, JSONEncodable, Hashable {

    public var objDebugPayload: CommonResponseObjDebugPayload
    public var objDebug: CommonResponseObjDebug?
    public var mPayload: EzsigntemplatesignatureGetObjectV4ResponseMPayload

    public init(objDebugPayload: CommonResponseObjDebugPayload, objDebug: CommonResponseObjDebug? = nil, mPayload: EzsigntemplatesignatureGetObjectV4ResponseMPayload) {
