//
// EzsignsigningreasonRequestCompound.swift
//
...
public struct EzsignsigningreasonRequestCompound: Codable, JSONEncodable, Hashable {
    ...
    public init(pkiEzsignsigningreasonID: Int? = nil, objEzsignsigningreasonDescription: MultilingualEzsignsigningreasonDescription, bEzsignsigningreasonIsactive: Bool) {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(pkiEzsignsigningreasonID, forKey: .pkiEzsignsigningreasonID)
