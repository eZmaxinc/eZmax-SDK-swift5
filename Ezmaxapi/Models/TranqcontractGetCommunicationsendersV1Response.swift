//
// TranqcontractGetCommunicationsendersV1Response.swift
//
...
public struct TranqcontractGetCommunicationsendersV1Response: Codable, JSONEncodable, Hashable {

    public var objDebugPayload: CommonResponseObjDebugPayload
    public var objDebug: CommonResponseObjDebug?
    public var mPayload: TranqcontractGetCommunicationsendersV1ResponseMPayload

    public init(objDebugPayload: CommonResponseObjDebugPayload, objDebug: CommonResponseObjDebug? = nil, mPayload: TranqcontractGetCommunicationsendersV1ResponseMPayload) {
