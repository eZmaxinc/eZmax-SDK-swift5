...
public struct EzsigndocumentGetCompletedElementsV1Response: Codable, JSONEncodable, Hashable {
    ...
    public init(objDebugPayload: CommonResponseObjDebugPayload, objDebug: CommonResponseObjDebug? = nil, mPayload: EzsigndocumentGetCompletedElementsV1ResponseMPayload) {
