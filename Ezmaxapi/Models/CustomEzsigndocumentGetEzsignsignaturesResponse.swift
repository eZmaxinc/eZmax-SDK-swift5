//
// CustomEzsigndocumentGetEzsignsignaturesResponse.swift
//
...
public struct CustomEzsigndocumentGetEzsignsignaturesResponse: Codable, JSONEncodable, Hashable {
    ...
    public init(pkiEzsigndocumentID: Int, sEzsigndocumentName: String, aObjEzsignsignature: [EzsignsignatureResponseCompound]) {
