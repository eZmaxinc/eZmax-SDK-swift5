//
// EzsigntemplatepublicGetFormsDataV1Response.swift
//
...
public struct EzsigntemplatepublicGetFormsDataV1Response: Codable, JSONEncodable, Hashable {

    public var objDebugPayload: CommonResponseObjDebugPayload
    public var objDebug: CommonResponseObjDebug?
    public var mPayload: EzsigntemplatepublicGetFormsDataV1ResponseMPayload

    public init(objDebugPayload: CommonResponseObjDebugPayload, objDebug: CommonResponseObjDebug? = nil, mPayload: EzsigntemplatepublicGetFormsDataV1ResponseMPayload) {
