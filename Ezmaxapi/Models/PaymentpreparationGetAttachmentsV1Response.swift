//
// PaymentpreparationGetAttachmentsV1Response.swift
//
...
public struct PaymentpreparationGetAttachmentsV1Response: Codable, JSONEncodable, Hashable {

    public var objDebugPayload: CommonResponseObjDebugPayload
    public var objDebug: CommonResponseObjDebug?
    public var mPayload: PaymentpreparationGetAttachmentsV1ResponseMPayload

    public init(objDebugPayload: CommonResponseObjDebugPayload, objDebug: CommonResponseObjDebug? = nil, mPayload: PaymentpreparationGetAttachmentsV1ResponseMPayload) {
