//
// InscriptiontempGetCommunicationListV1Response.swift
//
...
public struct InscriptiontempGetCommunicationListV1Response: Codable, JSONEncodable, Hashable {

    public var objDebugPayload: CommonResponseObjDebugPayloadGetList
    public var objDebug: CommonResponseObjDebug?
    public var mPayload: InscriptiontempGetCommunicationListV1ResponseMPayload

    public init(objDebugPayload: CommonResponseObjDebugPayloadGetList, objDebug: CommonResponseObjDebug? = nil, mPayload: InscriptiontempGetCommunicationListV1ResponseMPayload) {
