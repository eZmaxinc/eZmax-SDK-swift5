...
public struct EzsignsignerResponse: Codable, JSONEncodable, Hashable {

    public static let pkiEzsignsignerIDRule = NumericRule<Int>(minimum: 0, exclusiveMinimum: false, maximum: nil, exclusiveMaximum: false, multipleOf: nil)
    ...
    public init(pkiEzsignsignerID: Int, fkiTaxassignmentID: Int, fkiSecretquestionID: Int? = nil, fkiUserlogintypeID: Int, sUserlogintypeDescriptionX: String) {
