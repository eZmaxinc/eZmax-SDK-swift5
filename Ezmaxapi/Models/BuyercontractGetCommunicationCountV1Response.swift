//
// BuyercontractGetCommunicationCountV1Response.swift
//
...
public struct BuyercontractGetCommunicationCountV1Response: Codable, JSONEncodable, Hashable {

    public var objDebugPayload: CommonResponseObjDebugPayload
    public var objDebug: CommonResponseObjDebug?
    public var mPayload: BuyercontractGetCommunicationCountV1ResponseMPayload

    public init(objDebugPayload: CommonResponseObjDebugPayload, objDebug: CommonResponseObjDebug? = nil, mPayload: BuyercontractGetCommunicationCountV1ResponseMPayload) {
