//
// CustomEzsignfoldersignerassociationActionableElementResponseV2.swift
//
...
public struct CustomEzsignfoldersignerassociationActionableElementResponseV2: Codable, JSONEncodable, Hashable {
    ...
    public init(pkiEzsignfoldersignerassociationID: Int, fkiEzsignfolderID: Int, bEzsignfoldersignerassociationDelayedsend: Bool, eEzsignfoldersignerassociationRole: FieldEEzsignfoldersignerassociationRole, tEzsignfoldersignerassociationMessage: String, bEzsignfoldersignerassociationAllowsigninginperson: Bool, objEzsignsignergroup: EzsignsignergroupResponseCompound? = nil, objUser: EzsignfoldersignerassociationResponseCompoundUser? = nil, objEzsignsigner: EzsignsignerResponseCompound? = nil, bEzsignfoldersignerassociationHasactionableelementsCurrent: Bool, bEzsignfoldersignerassociationHasactionableelementsFuture: Bool) {
