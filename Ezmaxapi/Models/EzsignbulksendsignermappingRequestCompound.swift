//
// EzsignbulksendsignermappingRequestCompound.swift
//
...
public struct EzsignbulksendsignermappingRequestCompound: Codable, JSONEncodable, Hashable {
    ...
    public init(pkiEzsignbulksendsignermappingID: Int? = nil, fkiEzsignbulksendID: Int, fkiUserID: Int? = nil, bEzsignbulksendsignermappingReceivecopy: Bool? = nil, sEzsignbulksendsignermappingDescription: String) {
