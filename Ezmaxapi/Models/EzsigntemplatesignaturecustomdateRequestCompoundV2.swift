//
// EzsigntemplatesignaturecustomdateRequestCompoundV2.swift
//
...
public struct EzsigntemplatesignaturecustomdateRequestCompoundV2: Codable, JSONEncodable, Hashable {
    ...
    public init(pkiEzsigntemplatesignaturecustomdateID: Int? = nil, iEzsigntemplatesignaturecustomdateOffsetx: Int, iEzsigntemplatesignaturecustomdateOffsety: Int, sEzsigntemplatesignaturecustomdateFormat: String) {
