...
public struct SupplyListElement: Codable, JSONEncodable, Hashable {
    ...
    public init(pkiSupplyID: Int, fkiGlaccountID: Int? = nil, fkiGlaccountcontainerID: Int? = nil, fkiVariableexpenseID: Int, sSupplyCode: String, sSupplyDescriptionX: String, dSupplyUnitprice: String, bSupplyIsactive: Bool, bSupplyVariableprice: Bool, sGlaccountDescriptionX: String? = nil, sGlaccountcontainerLongdescriptionX: String? = nil, sVariableexpenseDescriptionX: String? = nil) {
