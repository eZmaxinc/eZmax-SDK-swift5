//
// EzsigntemplatesignaturecustomdateResponse.swift
//
...
public struct EzsigntemplatesignaturecustomdateResponse: Codable, JSONEncodable, Hashable {
    ...
    public init(pkiEzsigntemplatesignaturecustomdateID: Int, iEzsigntemplatesignaturecustomdateX: Int? = nil, iEzsigntemplatesignaturecustomdateY: Int? = nil, iEzsigntemplatesignaturecustomdateOffsetx: Int? = nil, iEzsigntemplatesignaturecustomdateOffsety: Int? = nil, sEzsigntemplatesignaturecustomdateFormat: String) {
