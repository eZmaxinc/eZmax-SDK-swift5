...
public struct UsergroupmembershipResponseCompound: Codable, JSONEncodable, Hashable {
    ...
    public init(pkiUsergroupmembershipID: Int, fkiUsergroupID: Int, fkiUserID: Int, sUserFirstname: String, sUserLastname: String, sUserLoginname: String, sEmailAddress: String? = nil, sUsergroupNameX: String) {
