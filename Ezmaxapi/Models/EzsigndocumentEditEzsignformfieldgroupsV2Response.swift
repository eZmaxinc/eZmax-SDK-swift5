//
// EzsigndocumentEditEzsignformfieldgroupsV2Response.swift
//
...
public struct EzsigndocumentEditEzsignformfieldgroupsV2Response: Codable, JSONEncodable, Hashable {

    public var objDebugPayload: CommonResponseObjDebugPayload
    public var objDebug: CommonResponseObjDebug?
    public var mPayload: EzsigndocumentEditEzsignformfieldgroupsV2ResponseMPayload

    public init(objDebugPayload: CommonResponseObjDebugPayload, objDebug: CommonResponseObjDebug? = nil, mPayload: EzsigndocumentEditEzsignformfieldgroupsV2ResponseMPayload) {
