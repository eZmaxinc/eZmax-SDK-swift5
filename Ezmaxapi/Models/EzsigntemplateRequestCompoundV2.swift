//
// EzsigntemplateRequestCompoundV2.swift
//
...
public struct EzsigntemplateRequestCompoundV2: Codable, JSONEncodable, Hashable {
    ...
    public init(pkiEzsigntemplateID: Int? = nil, fkiEzsignfoldertypeID: Int? = nil, fkiLanguageID: Int, sEzsigntemplateDescription: String, sEzsigntemplateFilenamepattern: String? = nil, bEzsigntemplateAdminonly: Bool, eEzsigntemplateType: FieldEEzsigntemplateType) {
