...
public struct EzsignfoldertypeResponseCompoundV4: Codable, JSONEncodable, Hashable {
    ...
    static let fkiPdfalevelIDConvertRule = NumericRule<Int>(minimum: 0, exclusiveMinimum: false, maximum: 255, exclusiveMaximum: false, multipleOf: nil)
    ...
    static let iEzsignfoldertypeSendreminderfirstdaysRule = NumericRule<Int>(minimum: 0, exclusiveMinimum: false, maximum: 255, exclusiveMaximum: false, multipleOf: nil)
    static let iEzsignfoldertypeSendreminderotherdaysRule = NumericRule<Int>(minimum: 0, exclusiveMinimum: false, maximum: 255, exclusiveMaximum: false, multipleOf: nil)
    ...
    static let iEzsignfoldertypePrematurelyendautomaticallydaysRule = NumericRule<Int>(minimum: 0, exclusiveMinimum: false, maximum: 255, exclusiveMaximum: false, multipleOf: nil)
