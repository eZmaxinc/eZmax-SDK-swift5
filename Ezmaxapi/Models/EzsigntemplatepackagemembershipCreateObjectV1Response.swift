...
public struct EzsigntemplatepackagemembershipCreateObjectV1Response: Codable, JSONEncodable, Hashable {
    ...
    public init(objDebugPayload: CommonResponseObjDebugPayload, objDebug: CommonResponseObjDebug? = nil, mPayload: EzsigntemplatepackagemembershipCreateObjectV1ResponseMPayload) {
