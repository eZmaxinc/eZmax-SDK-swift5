...
public struct EzsigntemplateResponse: Codable, JSONEncodable, Hashable {
    ...
    public static let sEzsigntemplateFilenamepatternRule = StringRule(minLength: nil, maxLength: nil, pattern: "/^.{1,50}$/")
