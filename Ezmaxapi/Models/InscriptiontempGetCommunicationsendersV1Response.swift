//
// InscriptiontempGetCommunicationsendersV1Response.swift
//
...
public struct InscriptiontempGetCommunicationsendersV1Response: Codable, JSONEncodable, Hashable {

    public var objDebugPayload: CommonResponseObjDebugPayload
    public var objDebug: CommonResponseObjDebug?
    public var mPayload: InscriptiontempGetCommunicationsendersV1ResponseMPayload

    public init(objDebugPayload: CommonResponseObjDebugPayload, objDebug: CommonResponseObjDebug? = nil, mPayload: InscriptiontempGetCommunicationsendersV1ResponseMPayload) {
