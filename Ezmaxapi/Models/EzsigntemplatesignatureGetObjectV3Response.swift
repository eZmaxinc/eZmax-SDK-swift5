//
// EzsigntemplatesignatureGetObjectV3Response.swift
//
...
public struct EzsigntemplatesignatureGetObjectV3Response: Codable, JSONEncodable, Hashable {

    public var objDebugPayload: CommonResponseObjDebugPayload
    public var objDebug: CommonResponseObjDebug?
    public var mPayload: EzsigntemplatesignatureGetObjectV3ResponseMPayload

    public init(objDebugPayload: CommonResponseObjDebugPayload, objDebug: CommonResponseObjDebug? = nil, mPayload: EzsigntemplatesignatureGetObjectV3ResponseMPayload) {
