//
// EzsignfolderGetCommunicationrecipientsV1Response.swift
//
...
public struct EzsignfolderGetCommunicationrecipientsV1Response: Codable, JSONEncodable, Hashable {

    public var objDebugPayload: CommonResponseObjDebugPayload
    public var objDebug: CommonResponseObjDebug?
    public var mPayload: EzsignfolderGetCommunicationrecipientsV1ResponseMPayload

    public init(objDebugPayload: CommonResponseObjDebugPayload, objDebug: CommonResponseObjDebug? = nil, mPayload: EzsignfolderGetCommunicationrecipientsV1ResponseMPayload) {
