//
// InscriptiontempGetCommunicationCountV1Response.swift
//
...
public struct InscriptiontempGetCommunicationCountV1Response: Codable, JSONEncodable, Hashable {

    public var objDebugPayload: CommonResponseObjDebugPayload
    public var objDebug: CommonResponseObjDebug?
    public var mPayload: InscriptiontempGetCommunicationCountV1ResponseMPayload

    public init(objDebugPayload: CommonResponseObjDebugPayload, objDebug: CommonResponseObjDebug? = nil, mPayload: InscriptiontempGetCommunicationCountV1ResponseMPayload) {
