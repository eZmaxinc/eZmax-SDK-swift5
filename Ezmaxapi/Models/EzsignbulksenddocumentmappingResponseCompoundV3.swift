//
// EzsignbulksenddocumentmappingResponseCompoundV3.swift
//
...
public struct EzsignbulksenddocumentmappingResponseCompoundV3: Codable, JSONEncodable, Hashable {
    ...
    public init(pkiEzsignbulksenddocumentmappingID: Int, fkiEzsignbulksendID: Int, fkiEzsigntemplatepackageID: Int? = nil, fkiEzsigntemplateID: Int? = nil, iEzsignbulksenddocumentmappingOrder: Int, objEzsigntemplate: EzsigntemplateResponseCompoundV4? = nil, objEzsigntemplatepackage: EzsigntemplatepackageResponseCompoundV3? = nil) {
