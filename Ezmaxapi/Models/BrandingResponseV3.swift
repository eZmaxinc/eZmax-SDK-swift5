...
/** A Branding Object */
public struct BrandingResponseV3: Codable, JSONEncodable, Hashable {
    ...
    public static let fkiEmailIDRule = NumericRule<Int>(minimum: 1, exclusiveMinimum: false, maximum: 16777215, exclusiveMaximum: false, multipleOf: nil)
    ...
    public init(pkiBrandingID: Int, fkiDomainID: Int? = nil, sDomainName: String? = nil, fkiEmailID: Int? = nil, objBrandingDescription: MultilingualBrandingDescription, sBrandingDescriptionX: String, sBrandingName: String? = nil, sEmailAddress: String? = nil, eBrandingLogo: FieldEBrandingLogo, eBrandingAlignlogo: FieldEBrandingAlignlogo, iBrandingColor: Int, bBrandingIsactive: Bool) {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(sDomainName, forKey: .sDomainName)
