//
// EzsigndocumentGetActionableElementsV3Response.swift
//
...
public struct EzsigndocumentGetActionableElementsV3Response: Codable, JSONEncodable, Hashable {

    public var objDebugPayload: CommonResponseObjDebugPayload
    public var objDebug: CommonResponseObjDebug?
    public var mPayload: EzsigndocumentGetActionableElementsV3ResponseMPayload

    public init(objDebugPayload: CommonResponseObjDebugPayload, objDebug: CommonResponseObjDebug? = nil, mPayload: EzsigndocumentGetActionableElementsV3ResponseMPayload) {
