//
// EzsigntemplatesignaturecustomdateRequestCompound.swift
//
...
public struct EzsigntemplatesignaturecustomdateRequestCompound: Codable, JSONEncodable, Hashable {

    static let pkiEzsigntemplatesignaturecustomdateIDRule = NumericRule<Int>(minimum: 0, exclusiveMinimum: false, maximum: nil, exclusiveMaximum: false, multipleOf: nil)
    static let iEzsigntemplatesignaturecustomdateXRule = NumericRule<Int>(minimum: 0, exclusiveMinimum: false, maximum: nil, exclusiveMaximum: false, multipleOf: nil)
    static let iEzsigntemplatesignaturecustomdateYRule = NumericRule<Int>(minimum: 0, exclusiveMinimum: false, maximum: nil, exclusiveMaximum: false, multipleOf: nil)
    static let iEzsigntemplatesignaturecustomdateOffsetxRule = NumericRule<Int>(minimum: 0, exclusiveMinimum: false, maximum: nil, exclusiveMaximum: false, multipleOf: nil)
    static let iEzsigntemplatesignaturecustomdateOffsetyRule = NumericRule<Int>(minimum: 0, exclusiveMinimum: false, maximum: nil, exclusiveMaximum: false, multipleOf: nil)
    ...
    public init(pkiEzsigntemplatesignaturecustomdateID: Int? = nil, iEzsigntemplatesignaturecustomdateX: Int? = nil, iEzsigntemplatesignaturecustomdateY: Int? = nil, iEzsigntemplatesignaturecustomdateOffsetx: Int? = nil, iEzsigntemplatesignaturecustomdateOffsety: Int? = nil, sEzsigntemplatesignaturecustomdateFormat: String) {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encodeIfPresent(pkiEzsigntemplatesignaturecustomdateID, forKey: .pkiEzsigntemplatesignaturecustomdateID)
        try container.encodeIfPresent(iEzsigntemplatesignaturecustomdateX, forKey: .iEzsigntemplatesignaturecustomdateX)
        try container.encodeIfPresent(iEzsigntemplatesignaturecustomdateY, forKey: .iEzsigntemplatesignaturecustomdateY)
        try container.encodeIfPresent(iEzsigntemplatesignaturecustomdateOffsetx, forKey: .iEzsigntemplatesignaturecustomdateOffsetx)
        try container.encodeIfPresent(iEzsigntemplatesignaturecustomdateOffsety, forKey: .iEzsigntemplatesignaturecustomdateOffsety)
