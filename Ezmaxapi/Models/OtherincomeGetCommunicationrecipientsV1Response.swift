//
// OtherincomeGetCommunicationrecipientsV1Response.swift
//
...
public struct OtherincomeGetCommunicationrecipientsV1Response: Codable, JSONEncodable, Hashable {

    public var objDebugPayload: CommonResponseObjDebugPayload
    public var objDebug: CommonResponseObjDebug?
    public var mPayload: OtherincomeGetCommunicationrecipientsV1ResponseMPayload

    public init(objDebugPayload: CommonResponseObjDebugPayload, objDebug: CommonResponseObjDebug? = nil, mPayload: OtherincomeGetCommunicationrecipientsV1ResponseMPayload) {
