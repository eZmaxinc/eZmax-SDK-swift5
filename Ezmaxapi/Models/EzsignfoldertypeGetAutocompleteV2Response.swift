...
public struct EzsignfoldertypeGetAutocompleteV2Response: Codable, JSONEncodable, Hashable {
    ...
    public init(objDebugPayload: CommonResponseObjDebugPayload, objDebug: CommonResponseObjDebug? = nil, mPayload: EzsignfoldertypeGetAutocompleteV2ResponseMPayload) {
