//
// InscriptionnotauthenticatedGetListV1Response.swift
//
...
public struct InscriptionnotauthenticatedGetListV1Response: Codable, JSONEncodable, Hashable {

    public var objDebugPayload: CommonResponseObjDebugPayloadGetList
    public var objDebug: CommonResponseObjDebug?
    public var mPayload: InscriptionnotauthenticatedGetListV1ResponseMPayload

    public init(objDebugPayload: CommonResponseObjDebugPayloadGetList, objDebug: CommonResponseObjDebug? = nil, mPayload: InscriptionnotauthenticatedGetListV1ResponseMPayload) {
