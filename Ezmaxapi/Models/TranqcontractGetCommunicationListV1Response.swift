//
// TranqcontractGetCommunicationListV1Response.swift
//
...
public struct TranqcontractGetCommunicationListV1Response: Codable, JSONEncodable, Hashable {

    public var objDebugPayload: CommonResponseObjDebugPayloadGetList
    public var objDebug: CommonResponseObjDebug?
    public var mPayload: TranqcontractGetCommunicationListV1ResponseMPayload

    public init(objDebugPayload: CommonResponseObjDebugPayloadGetList, objDebug: CommonResponseObjDebug? = nil, mPayload: TranqcontractGetCommunicationListV1ResponseMPayload) {
