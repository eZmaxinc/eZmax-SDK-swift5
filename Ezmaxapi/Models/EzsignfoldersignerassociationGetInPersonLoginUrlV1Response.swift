...
public struct EzsignfoldersignerassociationGetInPersonLoginUrlV1Response: Codable, JSONEncodable, Hashable {
    ...
    public init(objDebugPayload: CommonResponseObjDebugPayload, objDebug: CommonResponseObjDebug? = nil, mPayload: EzsignfoldersignerassociationGetInPersonLoginUrlV1ResponseMPayload) {
