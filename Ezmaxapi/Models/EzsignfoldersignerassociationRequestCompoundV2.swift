//
// EzsignfoldersignerassociationRequestCompoundV2.swift
//
...
public struct EzsignfoldersignerassociationRequestCompoundV2: Codable, JSONEncodable, Hashable {
    ...
    public init(pkiEzsignfoldersignerassociationID: Int? = nil, fkiUserID: Int? = nil, fkiEzsignsignergroupID: Int? = nil, fkiEzsignfolderID: Int, eEzsignfoldersignerassociationRole: FieldEEzsignfoldersignerassociationRole, tEzsignfoldersignerassociationMessage: String? = nil, objEzsignsigner: EzsignsignerRequestCompound? = nil) {
