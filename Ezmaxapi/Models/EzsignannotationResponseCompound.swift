//
// EzsignannotationResponseCompound.swift
//
...
public struct EzsignannotationResponseCompound: Codable, JSONEncodable, Hashable {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encode(pkiEzsignannotationID, forKey: .pkiEzsignannotationID)
