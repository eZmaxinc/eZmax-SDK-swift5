//
// EzdoctemplatedocumentGetListV1Response.swift
//
...
public struct EzdoctemplatedocumentGetListV1Response: Codable, JSONEncodable, Hashable {

    public var objDebugPayload: CommonResponseObjDebugPayloadGetList
    public var objDebug: CommonResponseObjDebug?
    public var mPayload: EzdoctemplatedocumentGetListV1ResponseMPayload

    public init(objDebugPayload: CommonResponseObjDebugPayloadGetList, objDebug: CommonResponseObjDebug? = nil, mPayload: EzdoctemplatedocumentGetListV1ResponseMPayload) {
