...
public struct EzsigndocumentGetEzsignformfieldgroupsV1Response: Codable, JSONEncodable, Hashable {
    ...
    public init(objDebugPayload: CommonResponseObjDebugPayload, objDebug: CommonResponseObjDebug? = nil, mPayload: EzsigndocumentGetEzsignformfieldgroupsV1ResponseMPayload) {
