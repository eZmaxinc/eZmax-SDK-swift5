//
// InscriptionGetCommunicationCountV1Response.swift
//
...
public struct InscriptionGetCommunicationCountV1Response: Codable, JSONEncodable, Hashable {

    public var objDebugPayload: CommonResponseObjDebugPayload
    public var objDebug: CommonResponseObjDebug?
    public var mPayload: InscriptionGetCommunicationCountV1ResponseMPayload

    public init(objDebugPayload: CommonResponseObjDebugPayload, objDebug: CommonResponseObjDebug? = nil, mPayload: InscriptionGetCommunicationCountV1ResponseMPayload) {
