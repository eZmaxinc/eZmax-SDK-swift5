...
public struct EzsignbulksendtransmissionGetObjectV2Response: Codable, JSONEncodable, Hashable {
    ...
    public init(objDebugPayload: CommonResponseObjDebugPayload, objDebug: CommonResponseObjDebug? = nil, mPayload: EzsignbulksendtransmissionGetObjectV2ResponseMPayload) {
