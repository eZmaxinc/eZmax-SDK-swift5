//
// InscriptionGetCommunicationsendersV1Response.swift
//
...
public struct InscriptionGetCommunicationsendersV1Response: Codable, JSONEncodable, Hashable {

    public var objDebugPayload: CommonResponseObjDebugPayload
    public var objDebug: CommonResponseObjDebug?
    public var mPayload: InscriptionGetCommunicationsendersV1ResponseMPayload

    public init(objDebugPayload: CommonResponseObjDebugPayload, objDebug: CommonResponseObjDebug? = nil, mPayload: InscriptionGetCommunicationsendersV1ResponseMPayload) {
