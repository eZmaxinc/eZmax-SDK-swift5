//
// EzsignfolderGetCommunicationsendersV1Response.swift
//
...
public struct EzsignfolderGetCommunicationsendersV1Response: Codable, JSONEncodable, Hashable {

    public var objDebugPayload: CommonResponseObjDebugPayload
    public var objDebug: CommonResponseObjDebug?
    public var mPayload: EzsignfolderGetCommunicationsendersV1ResponseMPayload

    public init(objDebugPayload: CommonResponseObjDebugPayload, objDebug: CommonResponseObjDebug? = nil, mPayload: EzsignfolderGetCommunicationsendersV1ResponseMPayload) {
