...
public struct CustomEzsignfoldertypeResponse: Codable, JSONEncodable, Hashable {
    ...
    public init(pkiEzsignfoldertypeID: Int, sEzsignfoldertypeNameX: String, bEzsignfoldertypeIncludeproofsigner: Bool, bEzsignfoldertypeIncludeproofuser: Bool, bEzsignfoldertypeDelegate: Bool? = nil, bEzsignfoldertypeReassign: Bool? = nil) {
