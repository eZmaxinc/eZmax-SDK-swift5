//
// EzsignbulksenddocumentmappingResponseCompound.swift
//
...
public struct EzsignbulksenddocumentmappingResponseCompound: Codable, JSONEncodable, Hashable {
    ...
    public init(pkiEzsignbulksenddocumentmappingID: Int, fkiEzsignbulksendID: Int, fkiEzsigntemplatepackageID: Int? = nil, fkiEzsigntemplateID: Int? = nil, iEzsignbulksenddocumentmappingOrder: Int, objEzsigntemplate: EzsigntemplateResponseCompound? = nil, objEzsigntemplatepackage: EzsigntemplatepackageResponseCompound? = nil) {
