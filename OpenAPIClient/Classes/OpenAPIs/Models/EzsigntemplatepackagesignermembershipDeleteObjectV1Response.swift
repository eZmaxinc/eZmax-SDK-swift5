...
public struct EzsigntemplatepackagesignermembershipDeleteObjectV1Response: Codable, JSONEncodable, Hashable {
    ...
    public init(mPayload: EzsigntemplatepackagesignermembershipDeleteObjectV1ResponseMPayload, objDebugPayload: CommonResponseObjDebugPayload? = nil, objDebug: CommonResponseObjDebug? = nil) {
