//
// EzsigntemplatepackagemembershipGetObjectV2Response.swift
//
...
public struct EzsigntemplatepackagemembershipGetObjectV2Response: Codable, JSONEncodable, Hashable {

    public var mPayload: EzsigntemplatepackagemembershipGetObjectV2ResponseMPayload
    public var objDebugPayload: CommonResponseObjDebugPayload?
    public var objDebug: CommonResponseObjDebug?

    public init(mPayload: EzsigntemplatepackagemembershipGetObjectV2ResponseMPayload, objDebugPayload: CommonResponseObjDebugPayload? = nil, objDebug: CommonResponseObjDebug? = nil) {
