...
public struct EzsignsignergroupCreateObjectV1Response: Codable, JSONEncodable, Hashable {
    ...
    public init(objDebugPayload: CommonResponseObjDebugPayload, objDebug: CommonResponseObjDebug? = nil, mPayload: EzsignsignergroupCreateObjectV1ResponseMPayload) {
