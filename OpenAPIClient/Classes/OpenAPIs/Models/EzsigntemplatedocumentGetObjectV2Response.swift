...
public struct EzsigntemplatedocumentGetObjectV2Response: Codable, JSONEncodable, Hashable {
    ...
    public init(objDebugPayload: CommonResponseObjDebugPayload, objDebug: CommonResponseObjDebug? = nil, mPayload: EzsigntemplatedocumentGetObjectV2ResponseMPayload) {
