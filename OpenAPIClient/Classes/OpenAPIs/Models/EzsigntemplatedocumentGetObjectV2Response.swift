//
// EzsigntemplatedocumentGetObjectV2Response.swift
//
...
public struct EzsigntemplatedocumentGetObjectV2Response: Codable, JSONEncodable, Hashable {

    public var mPayload: EzsigntemplatedocumentGetObjectV2ResponseMPayload
    public var objDebugPayload: CommonResponseObjDebugPayload?
    public var objDebug: CommonResponseObjDebug?

    public init(mPayload: EzsigntemplatedocumentGetObjectV2ResponseMPayload, objDebugPayload: CommonResponseObjDebugPayload? = nil, objDebug: CommonResponseObjDebug? = nil) {
