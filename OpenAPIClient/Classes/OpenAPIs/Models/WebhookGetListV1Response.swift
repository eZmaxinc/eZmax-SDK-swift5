//
// WebhookGetListV1Response.swift
//
...
public struct WebhookGetListV1Response: Codable, JSONEncodable, Hashable {

    public var mPayload: WebhookGetListV1ResponseMPayload
    public var objDebugPayload: CommonResponseObjDebugPayloadGetList?
    public var objDebug: CommonResponseObjDebug?

    public init(mPayload: WebhookGetListV1ResponseMPayload, objDebugPayload: CommonResponseObjDebugPayloadGetList? = nil, objDebug: CommonResponseObjDebug? = nil) {
