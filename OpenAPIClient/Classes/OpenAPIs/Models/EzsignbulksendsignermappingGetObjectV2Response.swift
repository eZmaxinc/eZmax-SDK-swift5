//
// EzsignbulksendsignermappingGetObjectV2Response.swift
//
...
public struct EzsignbulksendsignermappingGetObjectV2Response: Codable, JSONEncodable, Hashable {

    public var mPayload: EzsignbulksendsignermappingGetObjectV2ResponseMPayload
    public var objDebugPayload: CommonResponseObjDebugPayload?
    public var objDebug: CommonResponseObjDebug?

    public init(mPayload: EzsignbulksendsignermappingGetObjectV2ResponseMPayload, objDebugPayload: CommonResponseObjDebugPayload? = nil, objDebug: CommonResponseObjDebug? = nil) {
