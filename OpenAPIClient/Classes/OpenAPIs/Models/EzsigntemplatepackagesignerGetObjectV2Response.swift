//
// EzsigntemplatepackagesignerGetObjectV2Response.swift
//
...
public struct EzsigntemplatepackagesignerGetObjectV2Response: Codable, JSONEncodable, Hashable {

    public var mPayload: EzsigntemplatepackagesignerGetObjectV2ResponseMPayload
    public var objDebugPayload: CommonResponseObjDebugPayload?
    public var objDebug: CommonResponseObjDebug?

    public init(mPayload: EzsigntemplatepackagesignerGetObjectV2ResponseMPayload, objDebugPayload: CommonResponseObjDebugPayload? = nil, objDebug: CommonResponseObjDebug? = nil) {
