//
// EzsigndocumentGetCompletedElementsV1Response.swift
//
...
public struct EzsigndocumentGetCompletedElementsV1Response: Codable, JSONEncodable, Hashable {

    public var mPayload: EzsigndocumentGetCompletedElementsV1ResponseMPayload
    public var objDebugPayload: CommonResponseObjDebugPayload?
    public var objDebug: CommonResponseObjDebug?

    public init(mPayload: EzsigndocumentGetCompletedElementsV1ResponseMPayload, objDebugPayload: CommonResponseObjDebugPayload? = nil, objDebug: CommonResponseObjDebug? = nil) {
