//
// EzsigntemplatesignatureGetObjectV2Response.swift
//
...
public struct EzsigntemplatesignatureGetObjectV2Response: Codable, JSONEncodable, Hashable {

    public var mPayload: EzsigntemplatesignatureGetObjectV2ResponseMPayload
    public var objDebugPayload: CommonResponseObjDebugPayload?
    public var objDebug: CommonResponseObjDebug?

    public init(mPayload: EzsigntemplatesignatureGetObjectV2ResponseMPayload, objDebugPayload: CommonResponseObjDebugPayload? = nil, objDebug: CommonResponseObjDebug? = nil) {
