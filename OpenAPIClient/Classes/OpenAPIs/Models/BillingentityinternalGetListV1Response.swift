//
// BillingentityinternalGetListV1Response.swift
//
...
public struct BillingentityinternalGetListV1Response: Codable, JSONEncodable, Hashable {

    public var mPayload: BillingentityinternalGetListV1ResponseMPayload
    public var objDebugPayload: CommonResponseObjDebugPayloadGetList?
    public var objDebug: CommonResponseObjDebug?

    public init(mPayload: BillingentityinternalGetListV1ResponseMPayload, objDebugPayload: CommonResponseObjDebugPayloadGetList? = nil, objDebug: CommonResponseObjDebug? = nil) {
