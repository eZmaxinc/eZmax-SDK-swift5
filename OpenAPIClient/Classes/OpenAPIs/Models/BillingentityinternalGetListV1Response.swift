...
public struct BillingentityinternalGetListV1Response: Codable, JSONEncodable, Hashable {
    ...
    public init(objDebugPayload: CommonResponseObjDebugPayloadGetList, objDebug: CommonResponseObjDebug? = nil, mPayload: BillingentityinternalGetListV1ResponseMPayload) {
