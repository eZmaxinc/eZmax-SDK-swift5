//
// VariableexpenseGetAutocompleteV2Response.swift
//
...
public struct VariableexpenseGetAutocompleteV2Response: Codable, JSONEncodable, Hashable {

    public var mPayload: VariableexpenseGetAutocompleteV2ResponseMPayload
    public var objDebugPayload: CommonResponseObjDebugPayload?
    public var objDebug: CommonResponseObjDebug?

    public init(mPayload: VariableexpenseGetAutocompleteV2ResponseMPayload, objDebugPayload: CommonResponseObjDebugPayload? = nil, objDebug: CommonResponseObjDebug? = nil) {
