...
public struct EzsignfoldertypeRequest: Codable, JSONEncodable, Hashable {
    ...
    static let fkiUsergroupIDRule = NumericRule<Int>(minimum: 1, exclusiveMinimum: false, maximum: 255, exclusiveMaximum: false, multipleOf: nil)
    static let fkiUsergroupIDRestrictedRule = NumericRule<Int>(minimum: 1, exclusiveMinimum: false, maximum: 255, exclusiveMaximum: false, multipleOf: nil)
