//
// UsergroupEditUsergroupmembershipsV1Response.swift
//
...
public struct UsergroupEditUsergroupmembershipsV1Response: Codable, JSONEncodable, Hashable {

    public var mPayload: UsergroupEditUsergroupmembershipsV1ResponseMPayload
    public var objDebugPayload: CommonResponseObjDebugPayload?
    public var objDebug: CommonResponseObjDebug?

    public init(mPayload: UsergroupEditUsergroupmembershipsV1ResponseMPayload, objDebugPayload: CommonResponseObjDebugPayload? = nil, objDebug: CommonResponseObjDebug? = nil) {
