//
// EzsignformfieldRequestCompound.swift
//
...
public struct EzsignformfieldRequestCompound: Codable, JSONEncodable, Hashable {
    ...
    public init(pkiEzsignformfieldID: Int? = nil, iEzsignpagePagenumber: Int, sEzsignformfieldLabel: String, sEzsignformfieldValue: String? = nil, iEzsignformfieldX: Int, iEzsignformfieldY: Int, iEzsignformfieldWidth: Int, iEzsignformfieldHeight: Int, bEzsignformfieldSelected: Bool? = nil, sEzsignformfieldEnteredvalue: String? = nil) {
