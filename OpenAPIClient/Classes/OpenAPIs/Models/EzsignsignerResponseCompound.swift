...
public struct EzsignsignerResponseCompound: Codable, JSONEncodable, Hashable {
    ...
    public init(objContact: EzsignsignerResponseCompoundContact, fkiTaxassignmentID: Int, fkiSecretquestionID: Int? = nil, eEzsignsignerLogintype: EEzsignsignerLogintype, sEzsignsignerSecretanswer: String? = nil) {
