...
public struct EzsignsignerResponseCompound: Codable, JSONEncodable, Hashable {
    ...
    public init(objContact: EzsignsignerResponseCompoundContact, pkiEzsignsignerID: Int, fkiTaxassignmentID: Int, fkiSecretquestionID: Int? = nil, fkiUserlogintypeID: Int, sUserlogintypeDescriptionX: String) {
