//
// EzsignbulksendtransmissionGetObjectV2Response.swift
//
...
public struct EzsignbulksendtransmissionGetObjectV2Response: Codable, JSONEncodable, Hashable {

    public var mPayload: EzsignbulksendtransmissionGetObjectV2ResponseMPayload
    public var objDebugPayload: CommonResponseObjDebugPayload?
    public var objDebug: CommonResponseObjDebug?

    public init(mPayload: EzsignbulksendtransmissionGetObjectV2ResponseMPayload, objDebugPayload: CommonResponseObjDebugPayload? = nil, objDebug: CommonResponseObjDebug? = nil) {
