//
// EzsigntemplatepackageGetObjectV1Response.swift
//
...
public struct EzsigntemplatepackageGetObjectV1Response: Codable, JSONEncodable, Hashable {

    public var mPayload: EzsigntemplatepackageGetObjectV1ResponseMPayload
    public var objDebugPayload: CommonResponseObjDebugPayload?
    public var objDebug: CommonResponseObjDebug?

    public init(mPayload: EzsigntemplatepackageGetObjectV1ResponseMPayload, objDebugPayload: CommonResponseObjDebugPayload? = nil, objDebug: CommonResponseObjDebug? = nil) {
