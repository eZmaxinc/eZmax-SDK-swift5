//
// EzsignfolderGetEzsigndocumentsV1Response.swift
//
...
public struct EzsignfolderGetEzsigndocumentsV1Response: Codable, JSONEncodable, Hashable {

    public var mPayload: EzsignfolderGetEzsigndocumentsV1ResponseMPayload
    public var objDebugPayload: CommonResponseObjDebugPayload?
    public var objDebug: CommonResponseObjDebug?

    public init(mPayload: EzsignfolderGetEzsigndocumentsV1ResponseMPayload, objDebugPayload: CommonResponseObjDebugPayload? = nil, objDebug: CommonResponseObjDebug? = nil) {
