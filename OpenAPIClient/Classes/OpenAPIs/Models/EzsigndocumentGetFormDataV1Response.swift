//
// EzsigndocumentGetFormDataV1Response.swift
//
...
public struct EzsigndocumentGetFormDataV1Response: Codable, JSONEncodable, Hashable {
    ...
    public init(mPayload: EzsigndocumentGetFormDataV1ResponseMPayload, objDebugPayload: CommonResponseObjDebugPayload? = nil, objDebug: CommonResponseObjDebug? = nil) {
