//
// AuthenticateAuthenticateV2Response.swift
//
...
public struct AuthenticateAuthenticateV2Response: Codable, Hashable {
    ...
    public init(mPayload: AuthenticateAuthenticateV2ResponseMPayload, objDebugPayload: CommonResponseObjDebugPayload? = nil, objDebug: CommonResponseObjDebug? = nil) {
