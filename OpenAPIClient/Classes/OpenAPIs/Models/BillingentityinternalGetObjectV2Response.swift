//
// BillingentityinternalGetObjectV2Response.swift
//
...
public struct BillingentityinternalGetObjectV2Response: Codable, JSONEncodable, Hashable {

    public var mPayload: BillingentityinternalGetObjectV2ResponseMPayload
    public var objDebugPayload: CommonResponseObjDebugPayload?
    public var objDebug: CommonResponseObjDebug?

    public init(mPayload: BillingentityinternalGetObjectV2ResponseMPayload, objDebugPayload: CommonResponseObjDebugPayload? = nil, objDebug: CommonResponseObjDebug? = nil) {
