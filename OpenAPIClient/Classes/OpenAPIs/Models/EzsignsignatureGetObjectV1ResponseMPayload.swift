//
// EzsignsignatureGetObjectV1ResponseMPayload.swift
//
...
public struct EzsignsignatureGetObjectV1ResponseMPayload: Codable, JSONEncodable, Hashable {
    ...
    public init(pkiEzsignsignatureID: Int, fkiEzsignfoldersignerassociationID: Int, iEzsignpagePagenumber: Int, iEzsignsignatureX: Int, iEzsignsignatureY: Int, iEzsignsignatureStep: Int, eEzsignsignatureType: FieldEEzsignsignatureType, fkiEzsigndocumentID: Int, bEzsignsignatureCustomdate: Bool? = nil, aObjEzsignsignaturecustomdate: [EzsignsignaturecustomdateResponseCompound]? = nil) {
