//
// EzsignfoldertypeGetAutocompleteV2Response.swift
//
...
public struct EzsignfoldertypeGetAutocompleteV2Response: Codable, JSONEncodable, Hashable {

    public var mPayload: EzsignfoldertypeGetAutocompleteV2ResponseMPayload
    public var objDebugPayload: CommonResponseObjDebugPayload?
    public var objDebug: CommonResponseObjDebug?

    public init(mPayload: EzsignfoldertypeGetAutocompleteV2ResponseMPayload, objDebugPayload: CommonResponseObjDebugPayload? = nil, objDebug: CommonResponseObjDebug? = nil) {
