//
// EzsignsignaturecustomdateRequestCompound.swift
//
...
public struct EzsignsignaturecustomdateRequestCompound: Codable, JSONEncodable, Hashable {
    ...
    public init(pkiEzsignsignaturecustomdateID: Int? = nil, iEzsignsignaturecustomdateX: Int, iEzsignsignaturecustomdateY: Int, sEzsignsignaturecustomdateFormat: String) {
