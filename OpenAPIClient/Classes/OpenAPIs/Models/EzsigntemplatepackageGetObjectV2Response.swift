//
// EzsigntemplatepackageGetObjectV2Response.swift
//
...
public struct EzsigntemplatepackageGetObjectV2Response: Codable, JSONEncodable, Hashable {
    ...
    public init(mPayload: EzsigntemplatepackageGetObjectV2ResponseMPayload, objDebugPayload: CommonResponseObjDebugPayload? = nil, objDebug: CommonResponseObjDebug? = nil) {
