...
public struct EzsigntemplatepackageGetObjectV2Response: Codable, JSONEncodable, Hashable {
    ...
    public init(objDebugPayload: CommonResponseObjDebugPayload, objDebug: CommonResponseObjDebug? = nil, mPayload: EzsigntemplatepackageGetObjectV2ResponseMPayload) {
