//
// EzsignbulksendtransmissionGetObjectV1Response.swift
//
...
public struct EzsignbulksendtransmissionGetObjectV1Response: Codable, JSONEncodable, Hashable {
    ...
    public init(mPayload: EzsignbulksendtransmissionGetObjectV1ResponseMPayload, objDebugPayload: CommonResponseObjDebugPayload? = nil, objDebug: CommonResponseObjDebug? = nil) {
