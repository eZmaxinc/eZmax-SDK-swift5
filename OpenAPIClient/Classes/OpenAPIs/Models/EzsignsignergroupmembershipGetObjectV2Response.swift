//
// EzsignsignergroupmembershipGetObjectV2Response.swift
//
...
public struct EzsignsignergroupmembershipGetObjectV2Response: Codable, JSONEncodable, Hashable {

    public var mPayload: EzsignsignergroupmembershipGetObjectV2ResponseMPayload
    public var objDebugPayload: CommonResponseObjDebugPayload?
    public var objDebug: CommonResponseObjDebug?

    public init(mPayload: EzsignsignergroupmembershipGetObjectV2ResponseMPayload, objDebugPayload: CommonResponseObjDebugPayload? = nil, objDebug: CommonResponseObjDebug? = nil) {
