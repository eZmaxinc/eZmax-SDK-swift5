//
// EzsignbulksendsignermappingGetObjectV1Response.swift
//
...
public struct EzsignbulksendsignermappingGetObjectV1Response: Codable, JSONEncodable, Hashable {

    public var mPayload: EzsignbulksendsignermappingGetObjectV1ResponseMPayload
    public var objDebugPayload: CommonResponseObjDebugPayload?
    public var objDebug: CommonResponseObjDebug?

    public init(mPayload: EzsignbulksendsignermappingGetObjectV1ResponseMPayload, objDebugPayload: CommonResponseObjDebugPayload? = nil, objDebug: CommonResponseObjDebug? = nil) {
