...
public struct SubnetRequestCompound: Codable, JSONEncodable, Hashable {
    ...
    public init(pkiSubnetID: Int? = nil, fkiUserID: Int? = nil, fkiApikeyID: Int? = nil, objSubnetDescription: MultilingualSubnetDescription, iSubnetNetwork: Int, iSubnetMask: Int) {
