//
// EzsigntemplateformfieldgroupGetObjectV2Response.swift
//
...
public struct EzsigntemplateformfieldgroupGetObjectV2Response: Codable, JSONEncodable, Hashable {

    public var mPayload: EzsigntemplateformfieldgroupGetObjectV2ResponseMPayload
    public var objDebugPayload: CommonResponseObjDebugPayload?
    public var objDebug: CommonResponseObjDebug?

    public init(mPayload: EzsigntemplateformfieldgroupGetObjectV2ResponseMPayload, objDebugPayload: CommonResponseObjDebugPayload? = nil, objDebug: CommonResponseObjDebug? = nil) {
