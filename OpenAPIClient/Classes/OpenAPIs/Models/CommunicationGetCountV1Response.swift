//
// CommunicationGetCountV1Response.swift
//
...
public struct CommunicationGetCountV1Response: Codable, JSONEncodable, Hashable {
    ...
    public init(mPayload: CommunicationGetCountV1ResponseMPayload, objDebugPayload: CommonResponseObjDebugPayload? = nil, objDebug: CommonResponseObjDebug? = nil) {
