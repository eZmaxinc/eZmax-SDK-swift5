//
// NotificationsectionGetNotificationtestsV1Response.swift
//
...
public struct NotificationsectionGetNotificationtestsV1Response: Codable, JSONEncodable, Hashable {

    public var mPayload: NotificationsectionGetNotificationtestsV1ResponseMPayload
    public var objDebugPayload: CommonResponseObjDebugPayload?
    public var objDebug: CommonResponseObjDebug?

    public init(mPayload: NotificationsectionGetNotificationtestsV1ResponseMPayload, objDebugPayload: CommonResponseObjDebugPayload? = nil, objDebug: CommonResponseObjDebug? = nil) {
