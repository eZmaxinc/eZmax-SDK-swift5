//
// UsergroupGetUsergroupmembershipsV1Response.swift
//
...
public struct UsergroupGetUsergroupmembershipsV1Response: Codable, JSONEncodable, Hashable {

    public var mPayload: UsergroupGetUsergroupmembershipsV1ResponseMPayload
    public var objDebugPayload: CommonResponseObjDebugPayload?
    public var objDebug: CommonResponseObjDebug?

    public init(mPayload: UsergroupGetUsergroupmembershipsV1ResponseMPayload, objDebugPayload: CommonResponseObjDebugPayload? = nil, objDebug: CommonResponseObjDebug? = nil) {
