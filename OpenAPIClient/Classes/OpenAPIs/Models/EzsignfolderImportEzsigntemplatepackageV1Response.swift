//
// EzsignfolderImportEzsigntemplatepackageV1Response.swift
//
...
public struct EzsignfolderImportEzsigntemplatepackageV1Response: Codable, JSONEncodable, Hashable {

    public var mPayload: EzsignfolderImportEzsigntemplatepackageV1ResponseMPayload
    public var objDebugPayload: CommonResponseObjDebugPayload?
    public var objDebug: CommonResponseObjDebug?

    public init(mPayload: EzsignfolderImportEzsigntemplatepackageV1ResponseMPayload, objDebugPayload: CommonResponseObjDebugPayload? = nil, objDebug: CommonResponseObjDebug? = nil) {
