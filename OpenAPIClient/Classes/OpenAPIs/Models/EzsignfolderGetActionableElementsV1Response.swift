//
// EzsignfolderGetActionableElementsV1Response.swift
//
...
public struct EzsignfolderGetActionableElementsV1Response: Codable, JSONEncodable, Hashable {

    public var mPayload: EzsignfolderGetActionableElementsV1ResponseMPayload
    public var objDebugPayload: CommonResponseObjDebugPayload?
    public var objDebug: CommonResponseObjDebug?

    public init(mPayload: EzsignfolderGetActionableElementsV1ResponseMPayload, objDebugPayload: CommonResponseObjDebugPayload? = nil, objDebug: CommonResponseObjDebug? = nil) {
