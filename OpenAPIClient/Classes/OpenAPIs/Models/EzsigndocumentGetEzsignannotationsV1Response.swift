//
// EzsigndocumentGetEzsignannotationsV1Response.swift
//
...
public struct EzsigndocumentGetEzsignannotationsV1Response: Codable, JSONEncodable, Hashable {

    public var mPayload: EzsigndocumentGetEzsignannotationsV1ResponseMPayload
    public var objDebugPayload: CommonResponseObjDebugPayload?
    public var objDebug: CommonResponseObjDebug?

    public init(mPayload: EzsigndocumentGetEzsignannotationsV1ResponseMPayload, objDebugPayload: CommonResponseObjDebugPayload? = nil, objDebug: CommonResponseObjDebug? = nil) {
