...
public struct EzsignfolderGetCommunicationListV1Response: Codable, JSONEncodable, Hashable {
    ...
    public init(mPayload: EzsignfolderGetCommunicationListV1ResponseMPayload, objDebugPayload: CommonResponseObjDebugPayloadGetList? = nil, objDebug: CommonResponseObjDebug? = nil) {
