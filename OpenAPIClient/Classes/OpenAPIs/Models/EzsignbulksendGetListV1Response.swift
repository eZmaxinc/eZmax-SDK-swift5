//
// EzsignbulksendGetListV1Response.swift
//
...
public struct EzsignbulksendGetListV1Response: Codable, JSONEncodable, Hashable {
    ...
    public init(mPayload: EzsignbulksendGetListV1ResponseMPayload, objDebugPayload: CommonResponseObjDebugPayloadGetList? = nil, objDebug: CommonResponseObjDebug? = nil) {
