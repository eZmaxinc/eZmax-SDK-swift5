//
// EzsignformfieldgroupCreateObjectV1Response.swift
//
...
public struct EzsignformfieldgroupCreateObjectV1Response: Codable, JSONEncodable, Hashable {

    public var mPayload: EzsignformfieldgroupCreateObjectV1ResponseMPayload
    public var objDebugPayload: CommonResponseObjDebugPayload?
    public var objDebug: CommonResponseObjDebug?

    public init(mPayload: EzsignformfieldgroupCreateObjectV1ResponseMPayload, objDebugPayload: CommonResponseObjDebugPayload? = nil, objDebug: CommonResponseObjDebug? = nil) {
