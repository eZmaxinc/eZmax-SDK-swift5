...
public struct EzsignfoldertypeGetListV1Response: Codable, Hashable {

    public var mPayload: EzsignfoldertypeGetListV1ResponseMPayload
    public var objDebugPayload: CommonResponseObjDebugPayload?
    public var objDebug: CommonResponseObjDebug?

    public init(mPayload: EzsignfoldertypeGetListV1ResponseMPayload, objDebugPayload: CommonResponseObjDebugPayload? = nil, objDebug: CommonResponseObjDebug? = nil) {
