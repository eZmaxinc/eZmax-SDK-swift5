...
public struct EzsigntemplatepackageListElement: Codable, JSONEncodable, Hashable {
    ...
    public init(pkiEzsigntemplatepackageID: Int, fkiEzsignfoldertypeID: Int, fkiLanguageID: Int, sEzsigntemplatepackageDescription: String, bEzsigntemplatepackageIsactive: Bool, bEzsigntemplatepackageNeedvalidation: Bool, iEzsigntemplatepackagemembership: Int, sEzsignfoldertypeNameX: String) {
