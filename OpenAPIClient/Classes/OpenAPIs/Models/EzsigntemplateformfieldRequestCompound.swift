...
public struct EzsigntemplateformfieldRequestCompound: Codable, JSONEncodable, Hashable {
    ...
    public init(pkiEzsigntemplateformfieldID: Int? = nil, iEzsigntemplatedocumentpagePagenumber: Int, sEzsigntemplateformfieldLabel: String, sEzsigntemplateformfieldValue: String? = nil, iEzsigntemplateformfieldX: Int, iEzsigntemplateformfieldY: Int, iEzsigntemplateformfieldWidth: Int, iEzsigntemplateformfieldHeight: Int, bEzsigntemplateformfieldSelected: Bool? = nil) {
