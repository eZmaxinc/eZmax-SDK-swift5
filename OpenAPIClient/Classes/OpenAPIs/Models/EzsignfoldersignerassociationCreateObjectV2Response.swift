...
public struct EzsignfoldersignerassociationCreateObjectV2Response: Codable, JSONEncodable, Hashable {
    ...
    public init(objDebugPayload: CommonResponseObjDebugPayload, objDebug: CommonResponseObjDebug? = nil, mPayload: EzsignfoldersignerassociationCreateObjectV2ResponseMPayload) {
