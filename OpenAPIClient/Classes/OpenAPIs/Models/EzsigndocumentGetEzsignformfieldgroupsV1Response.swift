//
// EzsigndocumentGetEzsignformfieldgroupsV1Response.swift
//
...
public struct EzsigndocumentGetEzsignformfieldgroupsV1Response: Codable, JSONEncodable, Hashable {

    public var mPayload: EzsigndocumentGetEzsignformfieldgroupsV1ResponseMPayload
    public var objDebugPayload: CommonResponseObjDebugPayload?
    public var objDebug: CommonResponseObjDebug?

    public init(mPayload: EzsigndocumentGetEzsignformfieldgroupsV1ResponseMPayload, objDebugPayload: CommonResponseObjDebugPayload? = nil, objDebug: CommonResponseObjDebug? = nil) {
