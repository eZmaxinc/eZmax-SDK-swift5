//
// PaymenttermGetListV1Response.swift
//
...
public struct PaymenttermGetListV1Response: Codable, JSONEncodable, Hashable {

    public var mPayload: PaymenttermGetListV1ResponseMPayload
    public var objDebugPayload: CommonResponseObjDebugPayloadGetList?
    public var objDebug: CommonResponseObjDebug?

    public init(mPayload: PaymenttermGetListV1ResponseMPayload, objDebugPayload: CommonResponseObjDebugPayloadGetList? = nil, objDebug: CommonResponseObjDebug? = nil) {
