...
public struct EzsigntemplatesignaturecustomdateRequestCompound: Codable, JSONEncodable, Hashable {
    ...
    public init(pkiEzsigntemplatesignaturecustomdateID: Int? = nil, iEzsigntemplatesignaturecustomdateX: Int, iEzsigntemplatesignaturecustomdateY: Int, sEzsigntemplatesignaturecustomdateFormat: String) {
