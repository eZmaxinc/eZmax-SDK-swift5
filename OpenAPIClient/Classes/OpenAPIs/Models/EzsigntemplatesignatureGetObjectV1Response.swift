//
// EzsigntemplatesignatureGetObjectV1Response.swift
//
...
public struct EzsigntemplatesignatureGetObjectV1Response: Codable, JSONEncodable, Hashable {

    public var mPayload: EzsigntemplatesignatureGetObjectV1ResponseMPayload
    public var objDebugPayload: CommonResponseObjDebugPayload?
    public var objDebug: CommonResponseObjDebug?

    public init(mPayload: EzsigntemplatesignatureGetObjectV1ResponseMPayload, objDebugPayload: CommonResponseObjDebugPayload? = nil, objDebug: CommonResponseObjDebug? = nil) {
