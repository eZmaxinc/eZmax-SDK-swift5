...
public struct EzsignfoldersignerassociationGetObjectV1Response: Codable, JSONEncodable, Hashable {
    ...
    public init(mPayload: EzsignfoldersignerassociationGetObjectV1ResponseMPayload, objDebugPayload: CommonResponseObjDebugPayload? = nil, objDebug: CommonResponseObjDebug? = nil) {
