//
// EzsignsignergroupmembershipRequestCompound.swift
//
...
public struct EzsignsignergroupmembershipRequestCompound: Codable, JSONEncodable, Hashable {
    ...
    public init(pkiEzsignsignergroupmembershipID: Int? = nil, fkiEzsignsignergroupID: Int, fkiEzsignsignerID: Int, fkiUserID: Int, fkiUsergroupID: Int) {
