//
// EzsigndocumentEditEzsignsignaturesV1Response.swift
//
...
public struct EzsigndocumentEditEzsignsignaturesV1Response: Codable, JSONEncodable, Hashable {

    public var mPayload: EzsigndocumentEditEzsignsignaturesV1ResponseMPayload
    public var objDebugPayload: CommonResponseObjDebugPayload?
    public var objDebug: CommonResponseObjDebug?

    public init(mPayload: EzsigndocumentEditEzsignsignaturesV1ResponseMPayload, objDebugPayload: CommonResponseObjDebugPayload? = nil, objDebug: CommonResponseObjDebug? = nil) {
