...
public struct EzsignformfieldgroupGetObjectV2Response: Codable, JSONEncodable, Hashable {
    ...
    public init(objDebugPayload: CommonResponseObjDebugPayload, objDebug: CommonResponseObjDebug? = nil, mPayload: EzsignformfieldgroupGetObjectV2ResponseMPayload) {
