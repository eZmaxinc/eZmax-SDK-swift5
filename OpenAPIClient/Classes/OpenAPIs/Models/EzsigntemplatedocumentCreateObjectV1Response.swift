//
// EzsigntemplatedocumentCreateObjectV1Response.swift
//
...
public struct EzsigntemplatedocumentCreateObjectV1Response: Codable, JSONEncodable, Hashable {
    ...
    public init(mPayload: EzsigntemplatedocumentCreateObjectV1ResponseMPayload, objDebugPayload: CommonResponseObjDebugPayload? = nil, objDebug: CommonResponseObjDebug? = nil) {
