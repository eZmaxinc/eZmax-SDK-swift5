...
public struct EzsignsignaturecustomdateResponseCompound: Codable, JSONEncodable, Hashable {
    ...
    public init(pkiEzsignsignaturecustomdateID: Int, iEzsignsignaturecustomdateX: Int, iEzsignsignaturecustomdateY: Int, sEzsignsignaturecustomdateFormat: String) {
    ...
    public func encode(to encoder: Encoder) throws {
        ...
        try container.encode(iEzsignsignaturecustomdateX, forKey: .iEzsignsignaturecustomdateX)
        try container.encode(iEzsignsignaturecustomdateY, forKey: .iEzsignsignaturecustomdateY)
