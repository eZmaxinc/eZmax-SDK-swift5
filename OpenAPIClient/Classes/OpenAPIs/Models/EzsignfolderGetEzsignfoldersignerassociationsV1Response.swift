...
public struct EzsignfolderGetEzsignfoldersignerassociationsV1Response: Codable, JSONEncodable, Hashable {
    ...
    public init(mPayload: EzsignfolderGetEzsignfoldersignerassociationsV1ResponseMPayload, objDebugPayload: CommonResponseObjDebugPayload? = nil, objDebug: CommonResponseObjDebug? = nil) {
