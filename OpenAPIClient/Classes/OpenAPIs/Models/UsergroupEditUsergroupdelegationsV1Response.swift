//
// UsergroupEditUsergroupdelegationsV1Response.swift
//
...
public struct UsergroupEditUsergroupdelegationsV1Response: Codable, JSONEncodable, Hashable {

    public var objDebugPayload: CommonResponseObjDebugPayload
    public var objDebug: CommonResponseObjDebug?
    public var mPayload: UsergroupEditUsergroupdelegationsV1ResponseMPayload

    public init(objDebugPayload: CommonResponseObjDebugPayload, objDebug: CommonResponseObjDebug? = nil, mPayload: UsergroupEditUsergroupdelegationsV1ResponseMPayload) {
