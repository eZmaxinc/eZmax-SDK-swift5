//
// EzsigntemplatepackagemembershipCreateObjectV1Response.swift
//
...
public struct EzsigntemplatepackagemembershipCreateObjectV1Response: Codable, JSONEncodable, Hashable {
    ...
    public init(mPayload: EzsigntemplatepackagemembershipCreateObjectV1ResponseMPayload, objDebugPayload: CommonResponseObjDebugPayload? = nil, objDebug: CommonResponseObjDebug? = nil) {
