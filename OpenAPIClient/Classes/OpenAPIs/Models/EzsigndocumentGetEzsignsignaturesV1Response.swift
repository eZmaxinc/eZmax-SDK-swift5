//
// EzsigndocumentGetEzsignsignaturesV1Response.swift
//
...
public struct EzsigndocumentGetEzsignsignaturesV1Response: Codable, JSONEncodable, Hashable {
    ...
    public init(mPayload: EzsigndocumentGetEzsignsignaturesV1ResponseMPayload, objDebugPayload: CommonResponseObjDebugPayload? = nil, objDebug: CommonResponseObjDebug? = nil) {
