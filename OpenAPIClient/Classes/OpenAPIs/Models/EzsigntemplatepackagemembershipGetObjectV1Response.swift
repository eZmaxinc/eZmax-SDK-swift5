//
// EzsigntemplatepackagemembershipGetObjectV1Response.swift
//
...
public struct EzsigntemplatepackagemembershipGetObjectV1Response: Codable, JSONEncodable, Hashable {

    public var mPayload: EzsigntemplatepackagemembershipGetObjectV1ResponseMPayload
    public var objDebugPayload: CommonResponseObjDebugPayload?
    public var objDebug: CommonResponseObjDebug?

    public init(mPayload: EzsigntemplatepackagemembershipGetObjectV1ResponseMPayload, objDebugPayload: CommonResponseObjDebugPayload? = nil, objDebug: CommonResponseObjDebug? = nil) {
