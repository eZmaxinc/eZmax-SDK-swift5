...
public struct EzsignsignerRequestCompound: Codable, Hashable {
    ...
    public init(objContact: EzsignsignerRequestCompoundContact, fkiTaxassignmentID: Int, fkiSecretquestionID: Int? = nil, eEzsignsignerLogintype: EEzsignsignerLogintype, sEzsignsignerSecretanswer: String? = nil) {
