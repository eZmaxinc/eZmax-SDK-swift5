...
public struct EzsigntemplatepackagesignerDeleteObjectV1Response: Codable, JSONEncodable, Hashable {
    ...
    public init(objDebugPayload: CommonResponseObjDebugPayload, objDebug: CommonResponseObjDebug? = nil, mPayload: EzsigntemplatepackagesignerDeleteObjectV1ResponseMPayload) {
