//
// EzsigntemplatepackagesignerDeleteObjectV1Response.swift
//
...
public struct EzsigntemplatepackagesignerDeleteObjectV1Response: Codable, JSONEncodable, Hashable {
    ...
    public init(mPayload: EzsigntemplatepackagesignerDeleteObjectV1ResponseMPayload, objDebugPayload: CommonResponseObjDebugPayload? = nil, objDebug: CommonResponseObjDebug? = nil) {
