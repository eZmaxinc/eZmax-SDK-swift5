//
// FranchisebrokerGetAutocompleteV2Response.swift
//
...
public struct FranchisebrokerGetAutocompleteV2Response: Codable, JSONEncodable, Hashable {

    public var mPayload: FranchisebrokerGetAutocompleteV2ResponseMPayload
    public var objDebugPayload: CommonResponseObjDebugPayload?
    public var objDebug: CommonResponseObjDebug?

    public init(mPayload: FranchisebrokerGetAutocompleteV2ResponseMPayload, objDebugPayload: CommonResponseObjDebugPayload? = nil, objDebug: CommonResponseObjDebug? = nil) {
