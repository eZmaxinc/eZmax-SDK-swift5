//
// EzsigntemplateformfieldgroupGetObjectV1Response.swift
//
...
public struct EzsigntemplateformfieldgroupGetObjectV1Response: Codable, JSONEncodable, Hashable {

    public var mPayload: EzsigntemplateformfieldgroupGetObjectV1ResponseMPayload
    public var objDebugPayload: CommonResponseObjDebugPayload?
    public var objDebug: CommonResponseObjDebug?

    public init(mPayload: EzsigntemplateformfieldgroupGetObjectV1ResponseMPayload, objDebugPayload: CommonResponseObjDebugPayload? = nil, objDebug: CommonResponseObjDebug? = nil) {
