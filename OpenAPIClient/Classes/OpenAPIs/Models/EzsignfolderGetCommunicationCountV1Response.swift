...
public struct EzsignfolderGetCommunicationCountV1Response: Codable, JSONEncodable, Hashable {
    ...
    public init(objDebugPayload: CommonResponseObjDebugPayload, objDebug: CommonResponseObjDebug? = nil, mPayload: EzsignfolderGetCommunicationCountV1ResponseMPayload) {
