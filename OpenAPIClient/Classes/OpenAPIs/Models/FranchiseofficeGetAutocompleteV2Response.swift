//
// FranchiseofficeGetAutocompleteV2Response.swift
//
...
public struct FranchiseofficeGetAutocompleteV2Response: Codable, JSONEncodable, Hashable {

    public var mPayload: FranchiseofficeGetAutocompleteV2ResponseMPayload
    public var objDebugPayload: CommonResponseObjDebugPayload?
    public var objDebug: CommonResponseObjDebug?

    public init(mPayload: FranchiseofficeGetAutocompleteV2ResponseMPayload, objDebugPayload: CommonResponseObjDebugPayload? = nil, objDebug: CommonResponseObjDebug? = nil) {
