//
// EzsignbulksendtransmissionGetFormsDataV1Response.swift
//
...
public struct EzsignbulksendtransmissionGetFormsDataV1Response: Codable, JSONEncodable, Hashable {

    public var mPayload: EzsignbulksendtransmissionGetFormsDataV1ResponseMPayload
    public var objDebugPayload: CommonResponseObjDebugPayload?
    public var objDebug: CommonResponseObjDebug?

    public init(mPayload: EzsignbulksendtransmissionGetFormsDataV1ResponseMPayload, objDebugPayload: CommonResponseObjDebugPayload? = nil, objDebug: CommonResponseObjDebug? = nil) {
