//
// EzsigndocumentGetTemporaryProofV1Response.swift
//
...
public struct EzsigndocumentGetTemporaryProofV1Response: Codable, JSONEncodable, Hashable {

    public var mPayload: EzsigndocumentGetTemporaryProofV1ResponseMPayload
    public var objDebugPayload: CommonResponseObjDebugPayload?
    public var objDebug: CommonResponseObjDebug?

    public init(mPayload: EzsigndocumentGetTemporaryProofV1ResponseMPayload, objDebugPayload: CommonResponseObjDebugPayload? = nil, objDebug: CommonResponseObjDebug? = nil) {
