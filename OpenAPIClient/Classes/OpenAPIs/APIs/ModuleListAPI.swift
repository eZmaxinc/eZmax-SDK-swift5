...
open class ModuleListAPI {
     ...
     */
    open class func listListpresentationV1(sListName: String, listSaveListpresentationV1Request: ListSaveListpresentationV1Request, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: ListSaveListpresentationV1Response?, _ error: Error?) -> Void)) {
        listListpresentationV1WithRequestBuilder(sListName: sListName, listSaveListpresentationV1Request: listSaveListpresentationV1Request).execute(apiResponseQueue) { result in
            switch result {
     ...
     */
    open class func listListpresentationV1WithRequestBuilder(sListName: String, listSaveListpresentationV1Request: ListSaveListpresentationV1Request) -> RequestBuilder<ListSaveListpresentationV1Response> {
