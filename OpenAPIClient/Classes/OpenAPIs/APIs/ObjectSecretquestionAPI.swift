...
open class ObjectSecretquestionAPI {
     ...
     */
    @discardableResult
    open class func secretquestionGetAutocompleteV1(sSelector: SSelector_secretquestionGetAutocompleteV1, sQuery: String? = nil, acceptLanguage: HeaderAcceptLanguage? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: CommonGetAutocompleteV1Response?, _ error: Error?) -> Void)) -> RequestTask {
        return secretquestionGetAutocompleteV1WithRequestBuilder(sSelector: sSelector, sQuery: sQuery, acceptLanguage: acceptLanguage).execute(apiResponseQueue) { result in
            switch result {
     ...
     */
    open class func secretquestionGetAutocompleteV1WithRequestBuilder(sSelector: SSelector_secretquestionGetAutocompleteV1, sQuery: String? = nil, acceptLanguage: HeaderAcceptLanguage? = nil) -> RequestBuilder<CommonGetAutocompleteV1Response> {
