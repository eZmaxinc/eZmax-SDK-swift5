...
open class ObjectEzsigntemplateAPI {
     ...
     */
    @discardableResult
    open class func ezsigntemplateGetAutocompleteV1(sSelector: SSelector_ezsigntemplateGetAutocompleteV1, sQuery: String? = nil, acceptLanguage: HeaderAcceptLanguage? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: CommonGetAutocompleteV1Response?, _ error: Error?) -> Void)) -> RequestTask {
        return ezsigntemplateGetAutocompleteV1WithRequestBuilder(sSelector: sSelector, sQuery: sQuery, acceptLanguage: acceptLanguage).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
     ...
     */
    open class func ezsigntemplateGetAutocompleteV1WithRequestBuilder(sSelector: SSelector_ezsigntemplateGetAutocompleteV1, sQuery: String? = nil, acceptLanguage: HeaderAcceptLanguage? = nil) -> RequestBuilder<CommonGetAutocompleteV1Response> {
    ...
    public enum EOrderBy_ezsigntemplateGetListV1: String, CaseIterable {
        ...
        case sezsigntemplatetypedescriptionxAsc = "sEzsigntemplateTypedescriptionX_ASC"
        case sezsigntemplatetypedescriptionxDesc = "sEzsigntemplateTypedescriptionX_DESC"
