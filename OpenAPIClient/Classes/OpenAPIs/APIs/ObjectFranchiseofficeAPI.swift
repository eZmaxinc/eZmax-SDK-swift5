...
open class ObjectFranchiseofficeAPI {
     ...
     * enum for parameter sSelector
     */
    public enum SSelector_franchiseofficeGetAutocompleteV2: String, CaseIterable {
        case all = "All"
    }
     ...
     * enum for parameter eFilterActive
     */
    public enum EFilterActive_franchiseofficeGetAutocompleteV2: String, CaseIterable {
        case all = "All"
        case active = "Active"
        case inactive = "Inactive"
    }
     ...
     */
    @discardableResult
    open class func franchiseofficeGetAutocompleteV2(sSelector: SSelector_franchiseofficeGetAutocompleteV2, eFilterActive: EFilterActive_franchiseofficeGetAutocompleteV2? = nil, sQuery: String? = nil, acceptLanguage: HeaderAcceptLanguage? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: FranchiseofficeGetAutocompleteV2Response?, _ error: Error?) -> Void)) -> RequestTask {
        return franchiseofficeGetAutocompleteV2WithRequestBuilder(sSelector: sSelector, eFilterActive: eFilterActive, sQuery: sQuery, acceptLanguage: acceptLanguage).execute(apiResponseQueue) { result in
            switch result {
            case let .success(response):
                completion(response.body, nil)
            case let .failure(error):
    ...
    /**
     ...
     - parameter sQuery: (query) Allow to filter the returned results (optional)
     - parameter acceptLanguage: (header)  (optional)
     - returns: RequestBuilder<FranchiseofficeGetAutocompleteV2Response> 
     */
    open class func franchiseofficeGetAutocompleteV2WithRequestBuilder(sSelector: SSelector_franchiseofficeGetAutocompleteV2, eFilterActive: EFilterActive_franchiseofficeGetAutocompleteV2? = nil, sQuery: String? = nil, acceptLanguage: HeaderAcceptLanguage? = nil) -> RequestBuilder<FranchiseofficeGetAutocompleteV2Response> {
        var localVariablePath = "/2/object/franchiseoffice/getAutocomplete/{sSelector}"
        let sSelectorPreEscape = "\(sSelector.rawValue)"
        let sSelectorPostEscape = sSelectorPreEscape.addingPercentEncoding(withAllowedCharacters: .urlPathAllowed) ?? ""
        localVariablePath = localVariablePath.replacingOccurrences(of: "{sSelector}", with: sSelectorPostEscape, options: .literal, range: nil)
        let localVariableURLString = OpenAPIClientAPI.basePath + localVariablePath
        ...
        let localVariableRequestBuilder: RequestBuilder<FranchiseofficeGetAutocompleteV2Response>.Type = OpenAPIClientAPI.requestBuilderFactory.getBuilder()
