...
open class ObjectTaxassignmentAPI {
     ...
     */
    @discardableResult
    open class func taxassignmentGetAutocompleteV1(sSelector: SSelector_taxassignmentGetAutocompleteV1, sQuery: String? = nil, acceptLanguage: HeaderAcceptLanguage? = nil, apiResponseQueue: DispatchQueue = OpenAPIClientAPI.apiResponseQueue, completion: @escaping ((_ data: CommonGetAutocompleteV1Response?, _ error: Error?) -> Void)) -> RequestTask {
        return taxassignmentGetAutocompleteV1WithRequestBuilder(sSelector: sSelector, sQuery: sQuery, acceptLanguage: acceptLanguage).execute(apiResponseQueue) { result in
            switch result {
     ...
     */
    open class func taxassignmentGetAutocompleteV1WithRequestBuilder(sSelector: SSelector_taxassignmentGetAutocompleteV1, sQuery: String? = nil, acceptLanguage: HeaderAcceptLanguage? = nil) -> RequestBuilder<CommonGetAutocompleteV1Response> {
